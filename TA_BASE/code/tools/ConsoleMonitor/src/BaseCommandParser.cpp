...
{
    BaseCommandParser::BaseCommandParser()
        :m_moduleName(TA_Base_Core::InnerMonitorConsts::DEFAULT_MODUME_NAME)
    ...
    BaseCommandParser::~BaseCommandParser(void)
    {
        m_managedProcessCorba = TA_Base_Core::IManagedProcessCorbaDef::_nil();
        m_currIscsInteractiveObj = TA_Base_Core::ISCSInteractive::_nil();
    }

    bool BaseCommandParser::initCorbaEntity(const std::string & entityName, const std::string & endPoint)
    {
        ...
        LOG1(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "BaseCommandParser::setRunParam: corbaLocString <%s>", agentLocBuffer); 
    ...
    const char * BaseCommandParser::getModuleName()
    {
        return m_moduleName.c_str();
    }

    void BaseCommandParser::displayUsage()
    {
    ...
    std::string BaseCommandParser::getStateDesc()
    {
        std::ostringstream ostr;
        ostr << "module name: "<< m_moduleName << ", entity name: " << m_processedAgentEntityName <<", endpoint: " << m_processedAgentEndPoint;
        return ostr.str();
    }

    bool BaseCommandParser::processCommand(const std::vector<std::string> & vtCommandArgs)
    {
    ...
    void BaseCommandParser::parseCommand(const std::vector<std::string> & vtCommandArgs)
    {
    ...
    void BaseCommandParser::setRunParam(const char * paramName, const char * paramValue)
    {
    ...
    std::string BaseCommandParser::analyzeCommandInfo(CommandStateInfo & cmdInfo)
    {
        cmdInfo.nextStep = NEXTSTEP_NONE;
        return "NullCommand";
    }

    void BaseCommandParser::processInteractiveCommand(const std::vector<std::string> & vtCommandArgs)
    {
    ...
    void BaseCommandParser::connectInteractiveObj(const std::vector<std::string> & vtCommandArgs)
    {
        ...
        LOG1(SourceInfo, TA_Base_Core::DebugUtil::DebugInfo, "BaseCommandParser::connectInteractiveObj: corbaLocString <%s>", agentLocBuffer); 
    ...
    void BaseCommandParser::dumpCorbaReference()
    {
        if ( !CORBA::is_nil(m_managedProcessCorba) )
        {
