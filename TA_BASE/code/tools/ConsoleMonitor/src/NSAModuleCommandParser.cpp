...
namespace TA_Base_Core
{
    ...
    NSAModuleCommandParser::NSAModuleCommandParser(void)
        ...
        ,m_channelName("")
    {
        m_moduleName = TA_Base_Core::InnerMonitorConsts::NSA_MODULE_NAME;
    ...
    {
        if ( BaseCommandParser::processCommand(vtCommandArgs) )
        {
            return true;
        }
    ...
    {
        std::string baseContent = BaseCommandParser::getStateDesc();
    ...
    {
        BaseCommandParser::displayUsage();
