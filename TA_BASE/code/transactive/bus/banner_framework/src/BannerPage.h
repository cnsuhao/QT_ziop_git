/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/banner_framework/src/BannerPage.h $
  * @author:  Daniel Hoey
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
       ...
       /**
         ...
         */
		BannerPage(const std::string& buttonName, std::string viewType, int xPosition, int yPosition,
