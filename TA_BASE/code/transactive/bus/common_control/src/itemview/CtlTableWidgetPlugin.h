...
#ifndef _CtlTableWidgetPlugin_H_
#define _CtlTableWidgetPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlTableWidgetPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.TableView")
//#endif

public:
	explicit CtlTableWidgetPlugin(QObject* parent = 0);
