...
#ifndef _CtlTableViewPlugin_H_
#define _CtlTableViewPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlTableViewPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlTableViewPlugin(QObject* parent = 0);
