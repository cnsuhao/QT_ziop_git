...
#ifndef _CtlDateTimeEditPlugin_H_
#define _CtlDateTimeEditPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlDateTimeEditPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlDateTimeEditPlugin(QObject* parent = 0);
