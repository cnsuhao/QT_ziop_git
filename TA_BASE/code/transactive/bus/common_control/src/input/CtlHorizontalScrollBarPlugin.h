...
#ifndef _CtlHorizontalScrollBarPlugin_H_
#define _CtlHorizontalScrollBarPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlHorizontalScrollBarPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.ComboBox")
//#endif

public:
	CtlHorizontalScrollBarPlugin(QObject* parent=0);
	...
	virtual ~CtlHorizontalScrollBarPlugin();
