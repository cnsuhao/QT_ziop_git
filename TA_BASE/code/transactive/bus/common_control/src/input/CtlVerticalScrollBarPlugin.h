...
#ifndef _CtlVerticalScrollBarPlugin_H_
#define _CtlVerticalScrollBarPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlVerticalScrollBarPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlVerticalScrollBarPlugin(QObject* parent = 0);
	...
	virtual ~CtlVerticalScrollBarPlugin();
