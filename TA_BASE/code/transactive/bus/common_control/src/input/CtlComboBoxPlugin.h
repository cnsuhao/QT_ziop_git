...
#ifndef _CtlComboBoxPlugin_H_
#define _CtlComboBoxPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlComboBoxPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlComboBoxPlugin(QObject* parent = 0);
