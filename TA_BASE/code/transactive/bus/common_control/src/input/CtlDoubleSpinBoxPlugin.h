...
#ifndef _CtlDoubleSpinBoxPlugin_H_
#define _CtlDoubleSpinBoxPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlDoubleSpinBoxPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlDoubleSpinBoxPlugin(QObject* parent = 0);
	...
	virtual ~CtlDoubleSpinBoxPlugin();
