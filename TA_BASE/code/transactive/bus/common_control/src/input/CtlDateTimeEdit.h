...
* 
* The class implement customized QDateTimeEdit widgets.
*  
*
*/


#ifndef _CtlDateTimeEditH_
#define _CtlDateTimeEditH_
...
class  QDESIGNER_WIDGET_EXPORT CtlDateTimeEdit : public QDateTimeEdit  
{
    Q_OBJECT       
public:	 
	...
	*  @param parent
	*/
	explicit CtlDateTimeEdit(QWidget* parent = 0);
	/** Destructor  function
	*
	*/
	virtual ~CtlDateTimeEdit(); 
