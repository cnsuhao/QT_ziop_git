...
#ifndef _CtlTimeEditPlugin_H_
#define _CtlTimeEditPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlTimeEditPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlTimeEditPlugin(QObject* parent = 0);
