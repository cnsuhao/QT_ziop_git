...
#ifndef _CtlCheckBoxPlugin_H_
#define _CtlCheckBoxPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlCheckBoxPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.CheckBox")
//#endif

public:
	explicit CtlCheckBoxPlugin(QObject* parent = 0);
