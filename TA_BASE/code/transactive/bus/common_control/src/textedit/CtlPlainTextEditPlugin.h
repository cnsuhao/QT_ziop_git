...
#ifndef _CtlPlainTextEditPlugin_H_
#define _CtlPlainTextEditPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlPlainTextEditPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.PlainTextEdit")
//#endif

public:
	explicit CtlPlainTextEditPlugin(QObject* parent = 0);
	...
	virtual ~CtlPlainTextEditPlugin();
