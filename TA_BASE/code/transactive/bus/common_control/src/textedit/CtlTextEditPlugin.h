...
#ifndef _CtlTextEditPlugin_H_
#define _CtlTextEditPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlTextEditPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.TextEdit")
//#endif

public:
	explicit CtlTextEditPlugin(QObject* parent = 0);
