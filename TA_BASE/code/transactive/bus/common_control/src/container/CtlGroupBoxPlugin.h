...
#ifndef _CtlGroupBoxPlugin_H_
#define _CtlGroupBoxPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlGroupBoxPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.GroupBox")
//#endif

public:
	explicit CtlGroupBoxPlugin(QObject* parent = 0);
