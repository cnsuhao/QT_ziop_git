/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mathematical_evaluation/src/Tokeniser.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
...
namespace
{
    ...
    bool isValidRealNumber(const std::string& p_expression)
    {
        ...
        unsigned long decimal = p_expression.find_first_not_of(INTEGER_NUM);
