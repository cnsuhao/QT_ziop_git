...
#include "bus/generic_gui_view/ItaUserMessage/public_interfaces/ItaUserMessage.h"
#include <map>
...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        /** 
          ...
          */
	    virtual TAUnicodeString constructMessage(UINT uiMessageID);
        ...
        /** 
          ...
          * @param arg Parameter to be inserted into the message arguments member vector.
          */
        //virtual ItaUserMessage& operator << (const TAUnicodeString& arg);
