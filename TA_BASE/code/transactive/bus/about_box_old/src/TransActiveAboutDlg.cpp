/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/about_box/src/TransActiveAboutDlg.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
	...
	m_AppVersion( componentVersion )
{
	...
	m_AppName = componentName;
	m_BuildTime = buildDate;
	m_RelNumber = buildVersion;
	m_ProjectName = _T("TransActive");
	//}}AFX_DATA_INIT
	if( headerArraySize > 0 )
	{
		m_ProjectName = headerArray[0];
	}
	m_DialogTitle = _T("About ") + m_AppName;
}
