/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/tri_state_entity_tree_ctrl/src/TriStateEntityTreeItem.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{
	m_entityLabel.fromMultiByteString(entityData->getName().c_str());
}
...
const TCHAR* CTriStateEntityTreeItem::getItemLabelText()
{
