/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/response_plans/plan_tree/src/CategoryItem.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
const TCHAR* CCategoryItem::getItemLabelText()
{

	m_nodeLableText = TAUnicodeString::CreateFromMultitByteString(m_nodeSummary.name.in());
	//return m_nodeSummary.name.in();
	return m_nodeLableText.c_str();
}
