/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/user_settings/src/SettingsMgr.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    SettingsMgr::SettingsMgr(const std::string & sessionId, const unsigned long applicationType)
         : m_settings(NULL)
    {
    ...
    WINDOWPLACEMENT SettingsMgr::getWindowPlacementFromDB()
    {

        LOG( SourceInfo, DebugUtil::FunctionEntry, "getWindowPlacementFromDB");
    ...
    void SettingsMgr::saveWindowPlacementToDB(const WINDOWPLACEMENT & placement) 
    {
        LOG( SourceInfo, DebugUtil::FunctionEntry, "saveWindowPlacementToDB");
        ...
        LOG( SourceInfo, DebugUtil::FunctionExit, "saveWindowPlacementToDB");
    }
