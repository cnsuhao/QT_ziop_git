/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/user_settings/src/SettingsMgr.h $
  * @author:  
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
         ...
         * @exception UserSettingsException - If any error occurs and the setting cannot be retrieved.
         */
        WINDOWPLACEMENT getWindowPlacementFromDB();
         ...
         * @exception UserSettingsException - If any error occurs and the setting cannot be retrieved.
         */
        void saveWindowPlacementToDB(const WINDOWPLACEMENT & place);
