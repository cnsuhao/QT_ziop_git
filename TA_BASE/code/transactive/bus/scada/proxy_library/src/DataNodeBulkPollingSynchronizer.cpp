/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/scada/proxy_library/src/DataNodeBulkPollingSynchronizer.cpp $
...
namespace TA_Base_Bus
{
    ...
    {
        LOG_GENERIC( SourceInfo, DebugUtil::DebugDebug, "Creating DataNodeBulkPollingSynchronizer for %s", agentName.c_str() );
	...
	void DataNodeBulkPollingSynchronizer::timerExpired(long timerId, void* userData)
	{
		m_timerSemaphore.post();
	}
