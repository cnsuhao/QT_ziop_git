/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/scada/proxy_library/src/DataNodeBulkPollingSynchronizer.h $
...
namespace TA_Base_Bus
{
    ...
    class DataNodeBulkPollingSynchronizer : public AgentSynchronisationInterface, public TA_Base_Core::ITimeoutCallback
	{
		public:
