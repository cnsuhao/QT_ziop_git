/**
  ...
  *
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/generic_agent/src/GenericAgent.h $
  * @author:   Ross Tucker
  * @version:  $Revision: #1 $
...
namespace TA_Base_Bus
{
    ...
    class GenericAgent
        : public virtual POA_TA_Base_Core::IManagedAgentCorbaDef,
