/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/bus/alarm/alarm_list_control/pmodel/src/AlarmStore.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#include "bus/alarm/alarm_list_control/pmodel/src/CommonStructures.h"
...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        */
		...
		/**
		* reSetPreFilterLocationAndSession
		*
		* This uses old the prefilter, locations, and session ID to update alarm store
		*
		*/
