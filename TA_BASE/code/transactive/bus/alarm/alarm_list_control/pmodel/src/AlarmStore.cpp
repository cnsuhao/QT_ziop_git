/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/bus/alarm/alarm_list_control/pmodel/src/AlarmStore.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
    ...
    void AlarmStore::reSetPreFilterLocationAndSession()
    {
        TA_THREADGUARD(m_alarmStoreLock);
        m_bAlarmStoreValid = false;
        m_resolveAlarmStore.signal();
        LOG_GENERIC(SourceInfo, DebugUtil::DebugInfo, "reSetPreFilterLocationAndSession");
    }
