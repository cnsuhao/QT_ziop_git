 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/IAlarmListObserver.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Bus
{
	...
	public:
        ...
        */
         ...
         */
		virtual void setCurrentDescriptionText(const TAUtfString& description) = 0;
