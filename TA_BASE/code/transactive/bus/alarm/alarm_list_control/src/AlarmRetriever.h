 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/AlarmRetriever.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
//++Noel
#include "bus/alarm/alarm_list_control/pmodel/src/AlarmSelectionWrap.h"
...
namespace TA_Base_Bus
{
	...
	public:
         ...
         */
		virtual TAUtfString getCurrentAction();
         ...
         */
		virtual void setIsActionAlreadyRunning(bool isActionRunning, const TAUtfString& actionName = "");
