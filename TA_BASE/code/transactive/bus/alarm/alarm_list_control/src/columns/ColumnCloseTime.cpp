 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/columns/ColumnCloseTime.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
...
namespace TA_Base_Bus
{
    ...
    std::string ColumnCloseTime::getItemText(TA_Base_Core::AlarmDetailCorbaDef* alarm, DatabaseCache& databaseCache)
    {
