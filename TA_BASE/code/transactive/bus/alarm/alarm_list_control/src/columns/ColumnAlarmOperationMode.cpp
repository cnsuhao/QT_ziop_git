...
namespace TA_Base_Bus
{
	...
	const TAUtfString ColumnAlarmOperatorType::getItemText(unsigned long ulIndex)
	{
		try 
		{
			return TAUtfString::createFromMultitByteString(m_model->getDisplayDataWrap()->getItemString(ulIndex, ALARM_OPERATOR_MODE));
		}
		catch(...)
		{ 
			return "";
