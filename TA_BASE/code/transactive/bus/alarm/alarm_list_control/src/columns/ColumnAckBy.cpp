 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/columns/ColumnAckBy.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #4 $
 *
...
namespace TA_Base_Bus
{
	...
	const TAUtfString ColumnAckBy::getItemText(unsigned long ulIndex)
	{
		try
		{
			return TAUtfString::createFromMultitByteString(m_model->getDisplayDataWrap()->getItemString(ulIndex, ALARM_ACKNOWLEDGE_BY));
		}
		catch(...)
		{ 
