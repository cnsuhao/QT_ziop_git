 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/AlarmRetriever.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Bus
{
	...
	TAUtfString AlarmRetriever::getCurrentAction()
    {
	...
	void AlarmRetriever::setIsActionAlreadyRunning(bool isActionRunning, const TAUtfString& actionName)
    {
        TA_Base_Core::ThreadGuard guard(m_actionLock);
