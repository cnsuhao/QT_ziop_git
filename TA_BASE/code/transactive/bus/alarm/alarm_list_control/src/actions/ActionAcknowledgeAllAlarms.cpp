 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionAcknowledgeAllAlarms.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
{
    ActionAcknowledgeAllAlarms::ActionAcknowledgeAllAlarms(bool isAvailableInContextMenu /*=true*/)
    ...
    void ActionAcknowledgeAllAlarms::performAction(IAlarmRetriever& alarmRetriever)
    {
		...
		userMsg << tr("Are you sure you want to acknowledge all alarms?").toStdString(); //Need to improve;
