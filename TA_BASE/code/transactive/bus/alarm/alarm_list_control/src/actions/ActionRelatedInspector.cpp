 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionRelatedInspector.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #2 $
 *
    ...
    void ActionRelatedInspector::performAction(IAlarmRetriever& alarmRetriever)
    {
		...
		if (true == alarmDetail->isATSAlarm)
		{
			...
			try
			{
				...
				TA_Rect position = TA_Base_Bus::AppLauncher::getInstance().getRect(TA_GenericGui::SCREEN_CURRENT,
