 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/actions/ActionCloseAndAckAlarm.cpp $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
#include "bus/alarm/alarm_list_control/pmodel/src/DatabaseCache.h"
...
namespace TA_Base_Bus
{
    ...
    void ActionCloseAndAckAlarm::performAction(IAlarmRetriever& alarmRetriever)
    {
        ...
        alarmRetriever.setIsActionAlreadyRunning(true, tr("Closing and acknowledging alarms . . ."));
