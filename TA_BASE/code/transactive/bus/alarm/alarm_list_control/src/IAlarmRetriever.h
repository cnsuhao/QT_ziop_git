 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/IAlarmRetriever.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Bus
{
	...
	public:
       ...
       virtual DatabaseCache& getDatabaseCache() = 0;
         ...
         */
		virtual void setIsActionAlreadyRunning(bool isActionRunning, const TAUtfString& actionName = "") = 0;
