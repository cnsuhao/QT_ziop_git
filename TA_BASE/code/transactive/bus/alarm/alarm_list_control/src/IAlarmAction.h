 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/alarm/alarm_list_control/src/IAlarmAction.h $
 * @author:  Karen Graham
 * @version: $Revision: #3 $
 *
...
namespace TA_Base_Bus
{
	...
	public:
         ...
         *
		 * @controlID -control ID, it may be a child control ID.
         * @param IAlarmRetriever& - The object to use to find details and perform actions.
         *
		...
		virtual void setPModel(AlarmListModel* model) {m_model=model;};
	 

		virtual void preformPreAction(IAlarmRetriever& alarmRetriever){};
