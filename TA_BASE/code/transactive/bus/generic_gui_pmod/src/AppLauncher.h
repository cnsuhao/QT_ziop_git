/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/generic_gui_view/src/AppLauncher.h $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        /**
          ...
          *
          */
        TA_Rect getRect(const TA_Base_Bus::TA_GenericGui::EScreen targetScreen,
        ...
        /**
          ...
          *
          */
        static bool calculateNewCoordinates(TA_Rect& appDim,
    ...
    private:
        ...
        /**
          ...
          *
          */
        static void calculateRelativeRect(TA_Rect& appDim,
                                         const TA_Rect& objectDim,
        ...
        /**
          ...
          *
          */
        static void calculateNoOverlapRect(TA_Rect& appDim,
                                             const TA_Rect& objectDim,
                                             const unsigned long vAlign,
                                             const unsigned long hAlign);
        ...
        /**
          ...
          *
          */
        static void calculateBoundedRect(TA_Rect& appDim,
                                        const TA_Rect& boundaryDim,
                                        const unsigned long hAlign,
                                        const unsigned long vAlign,
        ...
        /**
          ...
          *
          */
        static void calculateRelativeBoundedRect(TA_Rect& appDim,
                                                const TA_Rect& objectDim,
                                                const TA_Rect& boundaryDim,
                                                const unsigned long hAlign,
                                                const unsigned long vAlign,
        ...
        /**
          ...
          *
          */
        static void calculateNoOverlapBoundedRect(TA_Rect& appDim,
                                                 const TA_Rect& objectDim,
                                                 const TA_Rect& boundaryDim,
                                                 const unsigned long hAlign,
                                                 const unsigned long vAlign,
        ...
        /**
          ...
          *
          */
        static void calculateRelativeCoordinates(TA_Rect& appDim,
                                             const TA_Rect& objectDim,
        ...
        /**
          ...
          *
          */
        static void calculateBoundedCoordinates(TA_Rect& appDim,
                                                const TA_Rect& boundaryDim,
                                                const unsigned long align,
                                                const bool isResizable);
        ...
        /**
          ...
          *
          */
        static bool calculateNoOverlapBoundedCoordinates(TA_Rect& appDim,
                                                        const TA_Rect& objectDim,
                                                        const TA_Rect& boundaryDim,
                                                        unsigned long align,
        ...
        /**
          ...
          */
        static bool isInvalidRect(const TA_Rect& rect);
        ...
        /**
          ...
          *
          */
        static void boundAppRect(TA_Rect& appDim,
                                const TA_Rect& boundaryDim,
                                const bool isResizable);
