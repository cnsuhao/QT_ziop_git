/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/bus/generic_gui_view/src/AppLauncher.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Bus
{
    ...
    TA_Rect AppLauncher::getRect(const EScreen targetScreen,
    ...
    void AppLauncher::launchApplication(const unsigned long appType,
                                        ...
                                        const TA_Rect* objectDim /*= NULL*/,
                                        const TA_Rect* boundaryDim /*= NULL*/)
    {
    ...
    bool AppLauncher::calculateNewCoordinates(TA_Rect& appDim,
    ...
    void AppLauncher::calculateRelativeRect(TA_Rect& appDim,
                                            const TA_Rect& objectDim,
    ...
    void AppLauncher::calculateNoOverlapRect(TA_Rect& appDim,
            const TA_Rect& objectDim,
            const unsigned long vAlign,
            const unsigned long hAlign)
    {
    ...
    void AppLauncher::calculateBoundedRect(TA_Rect& appDim,
                                           const TA_Rect& boundaryDim,
                                           const unsigned long hAlign,
                                           const unsigned long vAlign,
    ...
    void AppLauncher::calculateRelativeBoundedRect(TA_Rect& appDim,
            const TA_Rect& objectDim,
            const TA_Rect& boundaryDim,
            const unsigned long hAlign,
            const unsigned long vAlign,
    ...
    void AppLauncher::calculateNoOverlapBoundedRect(TA_Rect& appDim,
            const TA_Rect& objectDim,
            const TA_Rect& boundaryDim,
            const unsigned long hAlign,
            const unsigned long vAlign,
    ...
    void AppLauncher::calculateRelativeCoordinates(TA_Rect& appDim,
            const TA_Rect& objectDim,
    ...
    void AppLauncher::calculateBoundedCoordinates(TA_Rect& appDim,
            const TA_Rect& boundaryDim,
            const unsigned long align,
            const bool isResizable)
    {
    ...
    bool AppLauncher::calculateNoOverlapBoundedCoordinates(TA_Rect& appDim,
            const TA_Rect& objectDim,
            const TA_Rect& boundaryDim,
            unsigned long align,
    ...
    bool AppLauncher::isInvalidRect(const TA_Rect& rect)
    {
    ...
    void AppLauncher::boundAppRect(TA_Rect& appDim,
                                   const TA_Rect& boundaryDim,
                                   const bool isResizable)
    {
