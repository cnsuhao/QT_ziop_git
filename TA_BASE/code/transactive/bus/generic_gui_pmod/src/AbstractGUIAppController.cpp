...
namespace TA_Base_Bus
{
    ...
    AbstractGUIAppController::AbstractGUIAppController(ITransActiveApp* pWinApp, const char* applicatoinName)
    ...
    void AbstractGUIAppController::initAppController(const std::string& cmdLine, bool mustConnectControlStation)
    {
        ACE::init();
    ...
    void AbstractGUIAppController::setMainViewPosition()
    {
        ...
        TA_Rect windowRect = getMainViewRect();
    ...
    TA_Rect AbstractGUIAppController::getMainViewRect()
    {
    ...
    void AbstractGUIAppController::configureHelpFile()
    {
        ...
        if (! TA_Base_Core::RunParams::getInstance().get(RPARAM_HELPFILE).empty() || TA_Base_Core::RunParams::getInstance().isSet("LocalTest"))
        {
            // Already set
            FUNCTION_EXIT;
            return;
    ...
    void AbstractGUIAppController::getWorkAreaFromControlStation(const TA_Rect& rcNormalPosition, TA_Rect& workingArea)
    {
        ...
        try
        {
            ...
            LOG4(SourceInfo, TA_Base_Core::DebugUtil::DebugDebug, "Worker Area Info: ----------X=%d,Y=%d,CX=%d,CY=%d", workingArea.left, workingArea.top, workingArea.width(), workingArea.height());
        }
