...
{
	class GenericDemoAppController : public TA_Base_Bus::AbstractGUIAppController
	{
	public:
        GenericDemoAppController(TA_Base_Bus::ITransActiveWinApp * pApp, const char * appName);
		virtual ~GenericDemoAppController(void);
	public:
	...
	protected:
		...
		*/
        ...
        TA_Base_Bus::ITransActivePModel * createPModel( const std::string & pModelName );
