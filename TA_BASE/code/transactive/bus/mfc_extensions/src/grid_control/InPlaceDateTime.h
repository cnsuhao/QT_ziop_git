/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/grid_control/InPlaceDateTime.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
// Construction
public:
    CInPlaceDateTime(CWnd* pParent, CRect& rect, DWORD dwStyle, const TCHAR* dtFormat, UINT nID,
