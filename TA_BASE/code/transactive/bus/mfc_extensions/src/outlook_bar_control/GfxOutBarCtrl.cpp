/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/outlook_bar_control/GfxOutBarCtrl.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
int CGfxOutBarCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
    ...
    arialBoldFont.CreatePointFont(100, _T("Arial Bold"));
