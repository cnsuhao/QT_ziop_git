/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/tab_dialog_control/TabDialogCtrl.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
void CTabDialogCtrl::AddPage(CDialog&  dlg,UINT templateID,const CString& label)
{
