 ...
 * in any form
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/tab_dialog_control/tabdialogctrl.h $
 * @author:  Andy Parker
 * @version: $Revision: #1 $
 *
 * Last mofification: $DateTime: 2015/10/09 15:42:35 $
...
class AFX_EXT_CLASS CTabDialogCtrl : public CTabCtrl
{
	...
	protected:
		...
		void AddPage(CDialog&  dlg,UINT TemplateId, const CString& label);
		void ResizeDialogs();
