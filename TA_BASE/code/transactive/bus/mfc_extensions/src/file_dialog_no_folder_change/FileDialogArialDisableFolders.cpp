/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/file_dialog_no_folder_change/FileDialogArialDisableFolders.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Bus
{
	...
	LRESULT CALLBACK Hooker(int nCode, WPARAM wParam,  LPARAM lParam)
	{
		...
		if(_tcsicmp(szClassName, _T("toolbarwindow32")) == 0)
		{
	...
	{
		for(int i = 0; i < (int)_tcslen(szEditBuff); ++i)
