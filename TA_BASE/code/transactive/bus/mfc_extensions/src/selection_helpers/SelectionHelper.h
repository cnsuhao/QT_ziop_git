/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/selection_helpers/SelectionHelper.h $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
    namespace SelectionHelper
    {
         ...
         */
        #ifdef IMPORT_EXTENSIONS
        __declspec(dllimport) int findStringInComboCaseSensitive(const CComboBox& combo, const TCHAR* str);
        #else
        AFX_EXT_CLASS int findStringInComboCaseSensitive(const CComboBox& combo, const TCHAR* str);
        #endif                       
