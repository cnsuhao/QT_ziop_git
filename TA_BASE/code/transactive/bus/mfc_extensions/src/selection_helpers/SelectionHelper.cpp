/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/selection_helpers/SelectionHelper.cpp $
  * @author Jade Lee
  * @version $Revision: #1 $
...
namespace TA_Base_Bus
{
    namespace SelectionHelper
    {
        ...
        int findStringInComboCaseSensitive(const CComboBox& combo, const TCHAR* str)
        {
            int nIndex = -1;
            ...
            {
                nIndex = combo.FindStringExact(nIndex, str);
