/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/ListCellComboBox.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
