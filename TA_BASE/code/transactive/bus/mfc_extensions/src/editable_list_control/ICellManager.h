/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/ICellManager.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
#endif
{
    ...
    typedef std::vector<TAUnicodeString> CellData;
    ...
    virtual TAUnicodeString GetCellMask(CEditableListCtrl* listCtrl, int item, int subItem) = 0;
    ...
    virtual bool UpdateCellValue(CEditableListCtrl* listCtrl, int item, int subItem,  const TAUnicodeString& value) = 0;
};
