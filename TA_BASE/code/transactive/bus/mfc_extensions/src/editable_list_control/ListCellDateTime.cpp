/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/ListCellDateTime.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
void CListCellDateTime::Update() 
{
    ...
    else if (!m_parentUpdated)
	{
        ...
        if ( dwResult != 0 )
        {
            ...
            timeDest.ParseDateTime( str.str() );
        }
