/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/editable_list_control/EditableListCtrl.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
void CEditableListCtrl::startEdit()
{
    ...
    switch (cellType)
    {
        ...
        {
            TAUnicodeString mask = m_cellManager->GetCellMask(this, item, subItem);
            ...
            maskedEdit->Initialise(promptChar, mask.str(), GetItemText(item, subItem));
		...
		{		
			...
			TAUnicodeString str = checkOn? _T("Yes"):_T("No");
