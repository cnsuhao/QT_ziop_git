/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/standard_dialogs_arial_bold/FileDialogArial.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
		...
		CFileDialog(bOpenFileDialog, lpszDefExt, lpszFileName, dwFlags, lpszFilter, pParentWnd)
{
    ...
    m_font.CreatePointFont(100,_T("Arial Bold"),NULL); // 10pt Arial Bold
}
