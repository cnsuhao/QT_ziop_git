/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/coloured_controls/ColorCheck.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
void CColorCheck::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
    ...
    //
    captionSize = pDC->GetTextExtent(buffer, _tcslen(buffer));
...
void CColorCheck::DrawCheckCaption(CDC *pDC, CRect R,TCHAR *Buf, COLORREF TextColor, COLORREF TextShadowColor )
{
    ...
    pDC->DrawText(Buf, _tcslen(Buf), R, DT_CENTER|DT_VCENTER|DT_SINGLELINE);
