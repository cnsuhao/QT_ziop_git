/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/coloured_controls/ColorCheck.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
protected:
	...
	void DrawCheckCaption(CDC *pDC, CRect R, TCHAR *Buf, COLORREF TextColor, COLORREF TextShadowColor );
