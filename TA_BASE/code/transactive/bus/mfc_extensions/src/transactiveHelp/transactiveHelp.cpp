/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/transactiveHelp/transactiveHelp.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{
	TRANSACTIVEHELP_API int positionTransactiveHelp(const TCHAR* szHelp,
		...
		long bottom)
	{
		...
		WinType.pszFile = szHome;    
		WinType.pszHome =  szHome;    
