/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/object_tree_control/ObjectTreeCtrl.h $
  * @author Andy Parker
  * @version $Revision: #1 $
...
#endif
{
	...
	public:
		...
		CObjectTreeItem* findSelectedRootItem(const TCHAR* Key);
