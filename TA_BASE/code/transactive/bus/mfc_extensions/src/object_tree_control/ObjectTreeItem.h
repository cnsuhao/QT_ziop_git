/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/mfc_extensions/src/object_tree_control/ObjectTreeItem.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
#endif
{
	public:
		...
		CObjectTreeItem* findSelectedItem(const CString& item, EItemSearchType searchType = IST_BY_KEY);
