...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/security/rights_library/src/RightsLibrary.h $
...
namespace TA_Base_Bus
{
    ...
    public:
        ...
        virtual bool isActionPermittedOnResourceAndLocSub(const std::string& sessionId, unsigned long resourceKey,
        ...
        virtual void isActionPermittedOnResources(const std::string& sessionId,
                                                  ...
                                                  EDecisionModule& decisionModule)
        {
            returnResourceList = resourceKeys;
        }

        virtual void  areActionsPermittedOnSubsystemAndLocSub(const std::string& sessionId,
                                                              unsigned long resourceKey,
                                                              unsigned long locationKey,
                                                              unsigned long subsystemKey,
                                                              ActionList & actionKeys,
                                                              ActionList & returnActionList,
                                                              std::string& reasonString,
                                                              EDecisionModule& decisionModule)
        {
        ...
        virtual bool isActionPermittedOnResourceAndLocSubWithoutDuty(const std::string& sessionId,
                                                                     unsigned long resourceKey,
                                                                     unsigned long locationKey,
                                                                     unsigned long subsystemKey,
                                                                     unsigned long actionKey,
    ...
    public:
        ...
        static RightsLibraryFactory& getInstance();
        RightsLibraryFactory();
        ~RightsLibraryFactory() {}
    ...
    private:
        ...
        friend class ACE_Singleton<RightsLibraryFactory, ACE_Null_Mutex>;
    };
}
