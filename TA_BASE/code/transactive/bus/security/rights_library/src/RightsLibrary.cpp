/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/bus/security/rights_library/src/RightsLibrary.cpp $
...
{
    RightsLibraryFactory& RightsLibraryFactory::getInstance()
    {
        return *ACE_Unmanaged_Singleton<RightsLibraryFactory, ACE_Null_Mutex>::instance();
    }
