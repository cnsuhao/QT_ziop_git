...
#ifndef _CtlListViewPlugin_H_
#define _CtlListViewPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlListViewPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlListViewPlugin(QObject* parent = 0);
