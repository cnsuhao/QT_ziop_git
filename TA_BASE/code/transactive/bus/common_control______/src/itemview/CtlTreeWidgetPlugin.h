...
#ifndef _CtlTreeWidgetPlugin_H_
#define _CtlTreeWidgetPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlTreeWidgetPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlTreeWidgetPlugin(QObject* parent = 0);
...
Q_EXPORT_PLUGIN2(CtlTreeWidgetPlugin, CtlTreeWidgetPlugin)
