...
#ifndef _CtlDateEditPlugin_H_
#define _CtlDateEditPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlDateEditPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlDateEditPlugin(QObject* parent = 0);
