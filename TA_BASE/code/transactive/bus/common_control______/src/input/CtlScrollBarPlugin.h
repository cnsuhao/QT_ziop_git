...
#ifndef _CtlScrollBarPlugin_H_
#define _CtlScrollBarPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlScrollBarPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlScrollBarPlugin(QObject* parent = 0);
