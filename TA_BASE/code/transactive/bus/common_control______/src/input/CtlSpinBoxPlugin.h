...
#ifndef _CtlSpinBoxPlugin_H_
#define _CtlSpinBoxPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlSpinBoxPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	CtlSpinBoxPlugin(QObject* parent=0);
