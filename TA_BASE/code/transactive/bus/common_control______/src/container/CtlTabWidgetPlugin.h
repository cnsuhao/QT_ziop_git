...
#ifndef _CtlTabWidgetPlugin_H_
#define _CtlTabWidgetPlugin_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlTabWidgetPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
...
public:
	explicit CtlTabWidgetPlugin(QObject* parent = 0);
...
Q_EXPORT_PLUGIN2(CtlTabWidgetPlugin, CtlTabWidgetPlugin)
