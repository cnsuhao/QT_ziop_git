...
#ifndef _CtlLabelPLUGIN_H_
#define _CtlLabelPLUGIN_H_

#include <QDesignerCustomWidgetInterface>
QT_BEGIN_NAMESPACE
class CtlLabelPlugin : public QObject, public QDesignerCustomWidgetInterface
{
	Q_OBJECT
	Q_INTERFACES(QDesignerCustomWidgetInterface)
//#if QT_VERSION >= QT_VERSION_CHECK(5,0,0)
//    Q_PLUGIN_METADATA(IID "STEE.LSG.QT.CommonControl.Label")
//#endif

public:
 
	explicit CtlLabelPlugin(QObject* parent = 0);
