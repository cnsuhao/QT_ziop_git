...
namespace TrendViewer.DotTest.Factories.View
{
    ...
    public class AboutFactory
    {
        ...
        [ObjectFactoryMethod]
        [HashCode("+61VBA", "/MKr/g")]
        public static About CreateAbout01()
        {
            string aboutMsg = "Empty";
            About about = new About(aboutMsg);
            return about;
        }
        ...
        [TestAuthor("user")]
        [Test]
        public void TestCreateAbout01()
        {
            using (About about = CreateAbout01())
            {
        ...
        ///<summary>A caller is responsible for disposing the result</summary>
        [ObjectFactoryMethod]
        [HashCode("+61VBA", "+nRZww")]
        public static About CreateAbout02()
        {
        ...
        [TestAuthor("user")]
        [Test]
        public void TestCreateAbout02()
        {
            using (About about = CreateAbout02())
            {
                Assert.IsNotNull(about);
                #region Record State
                ValueRecorder recorder = new ValueRecorder();
