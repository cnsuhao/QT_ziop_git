    ...
    public class OPCDataSelectorFactory
    {
        ...
        public void TestCreateOPCDataSelector01()
        {
            using (OPCDataSelector oPCDataSelector = CreateOPCDataSelector01())
            {
                ...
                Assert.AreEqual(global::System.Windows.Forms.FormStartPosition.CenterParent, (FormStartPosition)oPCDataSelector.StartPosition);
                Assert.AreEqual("OPC Browser", (string)oPCDataSelector.Text);
