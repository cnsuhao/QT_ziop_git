 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/scada/EquipmentStatusViewer_prev/src/EquipmentStatusListCtrl.cpp $
 * @author:  Rod Rolirad
 * @version: $Revision: #1 $
 *
