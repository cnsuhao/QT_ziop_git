/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/InspectorPanel.h $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
#include "../pmodel/src/InspectorpanelAppController.h"
...
#define RESIZE_WINDOW_MESSAGE					(WM_USER + 6)
