...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/InformationListCtrl.h $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
#include "../pmodel/src/informationlistctrlmodel.h"
...
namespace TA_Base_App
{
	...
	class CInformationListCtrl : public CAbstractDataPointListCtrl, ICellManager
	{
		...
		protected:
			...
			void OnPaint();
	private:
			InformationListCtrlModel*		m_realPModel;
