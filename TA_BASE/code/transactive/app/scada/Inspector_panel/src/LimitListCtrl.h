...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/LimitListCtrl.h $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
#include "../pmodel/src/limitlistctrlmodel.h"
...
namespace TA_Base_App
{
	...
	class CLimitListCtrl : public CAbstractDataPointListCtrl, ICellManager
	{
		...
		protected:
			LimitListCtrlModel*		m_realPModel;
			CEdit&					m_limitInfo;
