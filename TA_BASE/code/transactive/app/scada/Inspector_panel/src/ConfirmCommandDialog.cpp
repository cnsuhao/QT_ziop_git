/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/ConfirmCommandDialog.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	void CConfirmCommandDialog::DoDataExchange(CDataExchange* pDX)
	{
		...
		DDX_Text(pDX, IDC_NEW_VALUE, m_newValue.str());
		DDX_Text(pDX, IDC_DATA_POINT, m_dataPoint.str());
		//}}AFX_DATA_MAP
		GetDlgItem(IDC_EDIT_EQUIPMENT)->SetWindowText(m_equipment.str());
	}
