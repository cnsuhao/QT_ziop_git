/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/ConfirmTagDialog.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	void CConfirmTagDialog::DoDataExchange(CDataExchange* pDX)
	{
		...
		DDX_Text(pDX, IDC_TAG, m_tag.str());
		DDX_Text(pDX, IDC_INHIBIT, m_inhibit.str());
		//}}AFX_DATA_MAP
	}
