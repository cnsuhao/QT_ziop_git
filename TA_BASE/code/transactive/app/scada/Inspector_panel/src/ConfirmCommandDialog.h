...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/ConfirmCommandDialog.h $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	class CConfirmCommandDialog : public CDialog
	{
		...
		// Dialog Data
			...
			TAUnicodeString	m_equipment;
			TAUnicodeString	m_newValue;
			TAUnicodeString	m_dataPoint;
			//}}AFX_DATA
