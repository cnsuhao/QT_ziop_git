/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/LimitDialog.cpp $
  * @author:  Andy Parker
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	void CLimitDialog::refreshAllData()
	{
		FUNCTION_ENTRY ("setEquipment()");

		m_limitDetailsList.refreshAllData();
		m_limitList.refreshAllData();		
