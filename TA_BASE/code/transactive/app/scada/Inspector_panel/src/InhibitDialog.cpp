/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/inspector_panel/src/InhibitDialog.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	void CInhibitDialog::refreshAllData()
	{
		FUNCTION_ENTRY ("setEquipment()");

		m_list.refreshAllData();
...
//			height += cellRect.Height()*(nItem+3);
	...
	void CInhibitDialog::updatePermissions()
	{
//		m_list.updatePermissions(true);
	}
