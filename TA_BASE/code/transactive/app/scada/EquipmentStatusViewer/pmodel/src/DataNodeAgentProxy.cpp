/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataNodeAgentProxy.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{
  	DataNodeAgentProxy::DataNodeAgentProxy(std::string & agentName, EquipmentItemPopulateLogic* populateLogic)
		:
				...
				try
				{
					...
					if (NULL != dataNodeUpdates)
					{
						...
						try
						{
							...
							{
								m_populateLogic->notifyDnUpdate(dnKeys);
