/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/DataNodeSummaryListItem.h $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        /** 
          ...
          */
        DataNodeSummaryListItem(unsigned long entitykey, TA_Base_Bus::ScadaProxyFactory& proxyFactory, EquipmentItemPopulateLogic* populateLogic);
