/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/scada/EquipmentStatusViewer/src/dlgbars.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{	
	...
	switch(lpDrawItemStruct->itemID) {
		...
		case 0:
			...
			TALoadString(STRING_ID_EDSV_0012, txtShow);
			dc.TextOut(rect.left+2, rect.top, txtShow.c_str());
			break;

		case 1:
			dc.SetTextColor(RGB(255, 0, 0));
			TALoadString(STRING_ID_EDSV_0013, txtShow);
			dc.TextOut(rect.left+2, rect.top, txtShow.c_str());
			break;
	}
