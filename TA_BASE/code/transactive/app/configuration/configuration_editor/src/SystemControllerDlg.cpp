/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/configuration/configuration_editor/src/SystemControllerDlg.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
    ...
    void SystemControllerDlg::onOK() 
    {
        ...
        if (-1 != std::string(portNumber).find_first_not_of("0123456789") )
        {
            CString portNumber;
