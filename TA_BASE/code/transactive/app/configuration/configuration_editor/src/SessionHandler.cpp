/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/configuration/configuration_editor/src/SessionHandler.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void SessionHandler::locateSystemController()
    {
        ...
        procManString.Format("corbaloc::1.2@1.2@%s:%lu/ProcessManager", hostName.c_str(), portNumber);
