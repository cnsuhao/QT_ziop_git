/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/configuration/config_plugins/event_plan_association/src/TA_EventPlanAssocConfigPlugin.cpp $
  * @author:  Brad Cleaver
  * @version: $Revision: #1 $
  *
