/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/configuration/config_plugins/system_controller_groups/src/TA_SystemControllerGroupConfigPlugin.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
