/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/configuration/config_plugins/plan_dss_rule/src/PlanDssRuleDetailView.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
END_MESSAGE_MAP()
	...
	void PlanDssRuleDetailView::onButtonThursday() 
	{
		...
		if ((m_pCurPlanDssRule->getValidThursday()) ^ (BST_CHECKED == m_validTuesDay.GetCheck()) )
		{
