/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/notification_service/AttNInteractive/AttNInteractive.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
        ...
        try
        {
            if (cmd == "help")
            {
                WriteStringToLog(
                    ...
                    " help \n"
                    " exit \n"
                    " setnsa <url>  (eg. setnsa corbaloc::1.2@1.2@callisto:9991/ChannelLocator) \n"
                    " listchannels \n"
            ...
            else if (cmd == "setnsa")
            {
                ...
                // of the form corbaloc::1.2@1.2@hostname:port/interface
                // (eg. "corbaloc::1.2@1.2@callisto:9991/ChannelLocator").
