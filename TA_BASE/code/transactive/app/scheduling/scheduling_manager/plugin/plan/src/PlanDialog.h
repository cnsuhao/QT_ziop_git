/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/scheduling/scheduling_manager/plugin/plan/src/PlanDialog.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        /** 
          ...
          *
          */
	    PlanDialog(bool readOnly, const TAUnicodeString& selectedPlanPath, CWnd* pParent = NULL);   // standard constructor
        ...
        /** 
          ...
          */
        TAUnicodeString getSelectedPlanPath() const
        {
    ...
    private:
        bool m_readOnly;
        TAUnicodeString m_selectedPlanPath;
    };
};
//{{AFX_INSERT_LOCATION}}
