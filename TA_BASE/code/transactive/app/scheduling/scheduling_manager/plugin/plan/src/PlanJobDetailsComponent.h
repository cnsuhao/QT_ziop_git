/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/scheduling/scheduling_manager/plugin/plan/src/PlanJobDetailsComponent.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private:
        /** 
          ...
          */
        TAUnicodeString getPlanPathFromParameters() const;
        ...
        /** 
          ...
          */  
        TAUnicodeString generateJobDescription(const TAUnicodeString& planPath) const;


    private:
        // The full path of the plan currently associated with this plan job.
        TAUnicodeString m_planPath;
    };
};
