/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/scheduling/scheduling_manager/src/IJobDetailsPlugin.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
#include "app/scheduling/scheduling_manager/plugin/model/src/SchedulingManagerStructs.h"
...
namespace TA_Base_App
{
    ...
    public:
        struct JobData
        {
            TAUnicodeString name;                           // auto generared job label
            TAUnicodeString description;                    // auto generated description of the job
