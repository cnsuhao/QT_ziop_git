/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/scheduling/scheduling_manager/src/JobDialog.h $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    private:
		...
		JobDialogModel* m_pJobDialogModel;
	protected:
		std::auto_ptr<TA_Base_Bus::ResizedViewHelper> m_resizeViewHelper; ///< wrapped function for resizing view
    };
};
//{{AFX_INSERT_LOCATION}}
