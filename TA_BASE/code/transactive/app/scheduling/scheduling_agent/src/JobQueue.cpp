/**
  ...
  *
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/scheduling/scheduling_agent/src/JobQueue.cpp $
...
void JobQueue::setControlMode()
{
    ...
    {
        LOG_GENERIC( SourceInfo, TA_Base_Core::DebugUtil::DebugInfo,
            "Second of minute > 30 (%d). Removing job instances.", secondOfMinute );
