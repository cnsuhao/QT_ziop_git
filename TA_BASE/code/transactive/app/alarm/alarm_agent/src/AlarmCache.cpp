/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/alarm/alarm_agent/src/AlarmCache.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
            ...
            alarm->state == TA_Base_Core::AlarmSuppressed )
        {
			...
			try  //add this try..catch. so the "current_AlarmID" can be popped up in any case. 
			{
				...
				if (true == bNeedNotifyUpdate )
				{
					...
					update->closeValue = alarm->alarmValue;
