/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/data_management/archive_manager/src/WriteArchiveHelper.h $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        WriteArchiveHelper(TA_Base_Core::IEntityData* guiEntity = NULL);
        ...
        /*void retrieveDataForDate( const time_t& startDate, const time_t& finishDate, 
            TA_ArchiveManager::FileStatusMap& fileStatusMap, FilePathsVector& archiveFiles, 
			CStatic & guiDateTextBox );*/ //------------Not used
