...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/data_management/archive_manager/src/RestoreArchiveHelper.h $
...
namespace TA_Base_App
{
    ...
    public:
		...
		typedef std::map< int, time_t > DatesIndexMap;
        ...
        RestoreArchiveHelper(TA_Base_Core::IEntityData* guiEntity);
