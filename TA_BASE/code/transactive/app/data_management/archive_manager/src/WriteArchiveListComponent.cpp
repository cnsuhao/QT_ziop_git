/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/data_management/archive_manager/src/WriteArchiveListComponent.cpp $
  * @author:  Wenguang
  * @version: $Revision: #1 $
  *
...
// 			strItem2.Replace("MB","");
			...
			iCompRes = atof(strItem1.toMultiByteStdString().c_str()) > atof(strItem2.toMultiByteStdString().c_str()) ? 1 : -1 ;	
		}
		//date MM/DD/YYYY
