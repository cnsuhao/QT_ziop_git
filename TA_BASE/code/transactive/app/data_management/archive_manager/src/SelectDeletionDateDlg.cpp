/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/data_management/archive_manager/src/SelectDeletionDateDlg.cpp $
...
namespace TA_Base_App
{
    SelectDeletionDateDlg::SelectDeletionDateDlg(CWnd* pParent /*=NULL*/)
	    : AbstractDialog(dynamic_cast<TA_Base_Bus::ITransActiveWinApp*> (AfxGetApp()),SelectDeletionDateDlg::IDD, pParent)
    {
        // Do nothing.
    }
    ...
    BEGIN_MESSAGE_MAP(SelectDeletionDateDlg, AbstractDialog)
