...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/data_management/archive_manager/src/SelectDeletionDateDlg.h $
...
{
    class SelectDeletionDateDlg : public TA_Base_Bus::AbstractDialog
    {
    public:
        /**
		...
		virtual std::string getMyPModelName(){return ARCHIVE_MANAGER_DLG_MODEL;}
