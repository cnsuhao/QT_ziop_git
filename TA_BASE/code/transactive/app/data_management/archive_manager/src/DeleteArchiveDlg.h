/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/data_management/archive_manager/src/DeleteArchiveDlg.h $
  * @author:  Alan Brims
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class DeleteArchiveDlg : public TA_Base_Bus::AbstractDialog, public TA_Base_Core::Thread
    {
