...
#include "app/event/event_viewer/pmodel/src/ATSRealTimeObserverManager.h"
...
namespace TA_Base_App
{
	...
	void ATSComWrapper::doComInitialize()
	{
			CoInitialize(0);
	}
