...
namespace TA_Base_App{
	...
	public:
		 ...
		 */
		static void setRefreshRate( unsigned long refreshRate);
...
// 		// The event list. This vector will point to the real stores(m_realtimeHandler.m_displaylist or m_historicalHandler.m_displaylist) 
// 		// according to the current mode(real-time or historical.)
// 		std::vector<DisplayItem*> * m_displayListPtr;
// 		// The event list. This vector stores all items that are not excluded by current filter.
// 		std::vector<DisplayItem*> * m_eventStoreListPtr;
	...
	protected:
		// ISCS aoto refresh rata:
		static unsigned long s_refreshRate;   // "ms"
