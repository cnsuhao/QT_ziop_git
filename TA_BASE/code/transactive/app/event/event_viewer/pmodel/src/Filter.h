...
* in any form.
*
* Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/Filter.h $
* @author:  Nick Jardine
* @version: $Revision: #1 $
*
...
#include "app/event/event_viewer/pmodel/src/DutyAdapter.h"
