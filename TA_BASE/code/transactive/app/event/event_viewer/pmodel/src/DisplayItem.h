 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/DisplayItem.h $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
public:
	...
	virtual const std::string getColumnDataForCompare(const std::string& columnName)=0;
