 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/event/event_viewer/src/DatabaseAccess.h $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
public:
   ...
   void load4FilterDlg();
	...
	/**
	 * getAlarmStatesMap_StringKey
	 *
	 * return alarm_state as a map, and make alarmStateName as Pkey.
	 */
