...
#include "app/event/event_viewer/pmodel/src/DisplayItem.h"
...
namespace TA_Base_App{
	...
	public:
		 ...
		 * @param cat, the EventCategory which the worker is working for.
		 */ 
		void setMaxRecordNumber(long maxNumber);
		 ...
		 */
		void clearAndReserveFor2Lists(unsigned long maxEvents);
		...
		*/
		 ...
		 * 
		 */
		void mergeSort(std::vector<DisplayItem*>& a, std::vector<DisplayItem*>& b);
		 ...
		 *
		 * @return vector<DisplayItem*>, the result after transforming
		 */
		std::vector<DisplayItem*>  transformData(std::vector<TA_Base_Core::ICombinedEventData*> & eventDatas,TA_Base_Core::EventCategory eventCategory);
		
		/** 
		 * processRefreshEvents
		 * 
		 * the process after handler get realtime refresh events
		 */
		void processRefreshEvents(std::vector<TA_Base_Core::ICombinedEventData*> & refreshList,TA_Base_Core::EventCategory eventCategory);
    ...
    {  
        ...
        {
            //return *arg1 < *arg2;
			return arg1->compareTo(arg2, EventHandler::s_sortColumnForRealTime.c_str(), EventHandler::s_sortAscendingForRealTime);
        }
    };
    ...
    {  
        ...
        {
            //return *arg1 < *arg2;
			return arg1->compareTo(arg2, EventHandler::s_sortColumnForHist.c_str(), EventHandler::s_sortAscendingForHist);
        }
    };
    ...
    {    
        ...
        {
            //return *arg1 < *arg2;
			return arg1->compareTo(arg2, EventHandler::s_sortColumnForGUI.c_str(), EventHandler::s_sortAscendingForGUI);
        }
    };
	...
	private:
		...
		/** 
		 * IsWorkerFinishedLoading
		 *
		 * find the specific worker and check the status, if it is FinishSearch, return true (for realtime it means backlog earching finished )
		 * If the worker doesn't exist, return true
		 *
		 * @return bool, whether the worker has finished loading.
		 *
		 * @param eventCategory, the specific EventCategory
		 */
		bool IsWorkerFinishedLoading(TA_Base_Core::EventCategory eventCategory);
		 ...
		 */ 
		void addCache( std::vector<DisplayItem*>& eventItems);
