...
* in any form.
*
* Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/event/event_viewer/EventListComponent/src/Filter.cpp $
* @author:  Nick Jardine
* @version: $Revision: #1 $
*
...
#include "app/event/event_viewer/pmodel/src/EventHandlerManager.h"
...
if( m_historicalHandler == NULL || m_realtimeHandler==NULL)
{
return;
}
int listSize = (getDisplayMode() == HistoricalMode) ? 
m_historicalHandler->getDislplaySize(): m_realtimeHandler->getDislplaySize();
if ( listSize >= EventHandlerManager::maxEvents )
{
...
PostMessage( m_hwndDlgWnd, WM_USER_LIST_UPDATE, listSize, pageStatus );
PostMessage( m_hwndDlgWnd, WM_USER_LISTVIEW_UPDATE, listSize, pageStatus );
