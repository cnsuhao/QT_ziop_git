...
* in any form.
*
* Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/event/event_viewer/src/CombinedEventFilter.h $
...
public:
	...
	*
	*/
	virtual void initEventsCount(int maxEvents, int refreshTime);
