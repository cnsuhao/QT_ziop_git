 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/event/event_viewer/src/CombinedEventItem.h $
...
public:
	...
	virtual const std::string  getColumnDataForCompare(const std::string& columnName);
	void setColumnData (std::string columnName, std::string value);
...
/*    virtual bool operator<(DisplayItem& rhs);*/
	 ...
	 * getATSEventID
	 *
	 * return the value of m_atsEventID
	 */ 
	std::string getATSEventID();
