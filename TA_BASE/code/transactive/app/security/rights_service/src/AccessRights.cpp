/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/security/rights_service/src/AccessRights.cpp $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
void CAccessRights::retrieveRunParams()
{
    ...
    sprintf(ior, "corbaloc::1.2@localhost:%lu/ProcessManager", port);
