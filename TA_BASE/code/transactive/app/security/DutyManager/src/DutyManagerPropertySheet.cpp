/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/security/DutyManager/src/DutyManagerPropertySheet.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
DutyManagerPropertySheet::DutyManagerPropertySheet() :
	CMultiFontPropertySheet(STRING_ID_DUTY_MANAGER_0000, NULL, 0)
{
}
