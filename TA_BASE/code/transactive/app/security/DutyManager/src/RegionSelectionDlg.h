...
{
	class RegionSelectionDlgModel;

    class RegionSelectionDlg : public TA_Base_Bus::AbstractDialog
    {
    // Operations
    public:
	    RegionSelectionDlg(TA_Base_Bus::ITransActiveWinApp * app,  CWnd* pParent = NULL);
    ...
    private:
		...
		// ++++++++++++++++++++++++
		RegionSelectionDlgModel * m_realPModel;
    };
