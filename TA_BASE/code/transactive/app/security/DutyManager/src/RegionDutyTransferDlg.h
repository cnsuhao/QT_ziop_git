...
{
	class RegionDutyTransferDlgModel;

    class RegionDutyTransferDlg : public TA_Base_Bus::AbstractDialog
    {
    // Operations
    public:
	    RegionDutyTransferDlg(TA_Base_Bus::ITransActiveWinApp * app,  CWnd* pParent = NULL);
    ...
    private:
		...
		// ++++++++++++++++++++++++
		RegionDutyTransferDlgModel * m_realPModel;
