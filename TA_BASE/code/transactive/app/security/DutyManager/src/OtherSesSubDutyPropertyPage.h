...
namespace TA_Base_App
{
	...
	class OtherSesSubDutyPropertyPageModel;
...
//										public TA_Base_Bus::ISubsystemDutyObserver
	class OtherSesSubDutyPropertyPage : public AbstractPropertyPage
	{
		//DECLARE_DYNCREATE(OtherSesSubDutyPropertyPage)
			
			// Construction
	public:
		OtherSesSubDutyPropertyPage(ITransActiveWinApp * pWinApp, UINT nIDTemplate, UINT nIDCaption = 0 );
		virtual ~OtherSesSubDutyPropertyPage();

		// AbstractPropertyPage
		virtual BOOL OnInitDialog();
		// AbstractPropertyPage AbstractTransActiveFormView
		//virtual void updateView() {};
		//virtual void initUIControl() {};
		//virtual void syncUIDataToPModel() {};
		// AbstractPropertyPage AbstractTransActiveFormView AbstractTransActiveView
	...
	protected:
		...
		afx_msg LRESULT OnUpdateOtherSesSubDutyMessage(WPARAM, LPARAM);								// no used
	...
	private:
		...
		void sessionUpdateRegionDuty(const SessionUpdate& sessionUpdate);
		void sessionUpdateSubsystemDuty(const SessionUpdate& sessionUpdate);
...
//        TA_Base_Bus::DutyRights m_dutyRights;
  ...
  //      TA_Base_Bus::SessionInfoEx m_currentSessionInfo;
		...
		//+++++++++++++++++++
		OtherSesSubDutyPropertyPageModel* m_realPModel;
	};
}
