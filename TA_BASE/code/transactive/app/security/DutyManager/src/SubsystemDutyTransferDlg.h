...
{
	class SubsystemDutyTransferDlgModel;

    class SubsystemDutyTransferDlg : public TA_Base_Bus::AbstractDialog
    {
    // Operations
    public:
	    SubsystemDutyTransferDlg(TA_Base_Bus::ITransActiveWinApp * app,  CWnd* pParent = NULL);
    ...
    private:
		...
		// ++++++++++++++++++++++++
		SubsystemDutyTransferDlgModel * m_realPModel;
    };
