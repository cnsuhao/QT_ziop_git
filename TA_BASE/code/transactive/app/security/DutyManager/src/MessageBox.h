...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/security/DutyManager/src/MessageBox.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
		...
		static void error(const std::string& message, const std::string& exceptionMessage, const std::string& exceptionDetail);
