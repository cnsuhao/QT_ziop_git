...
bool Utilities::retrieveSessionId()
{
            ...
            RunParams::getInstance().isSet(RPARAM_PASSWORD))
    {
        ...
        while (!resolvedAuthenticationAgent)
        {
            try
            {
                LOG_DEBUG("Requesting session from Authentication Agent");
            ...
            {
                LOG_WARNING("Failed to request session from Authentication Agent");
            ...
            {
                LOG_WARNING("An unexpected error occured while requesting session from Authentication Agent");
                resolvedAuthenticationAgent = false;
            }
