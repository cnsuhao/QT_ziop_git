/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_controller/src/ProcessInfo.cpp $
...
TA_Base_Core::NonReEntrantThreadLockable TA_Base_App::ProcessInfo::m_lock;
