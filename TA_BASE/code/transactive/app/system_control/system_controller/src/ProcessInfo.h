/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_controller/src/ProcessInfo.h $
...
namespace TA_Base_App
{
    ...
    public:
		...
		/**
          ...
          * @return The PID.
          */
        TA_Base_Core::ProcessId getProcessId() const
        {
        ...
        /**
          ...
          */
        TA_Base_Core::EProcessStatus getProcessStatus() const
        {
            TA_Base_Core::ThreadGuard guard(m_lock);
        ...
        /**
          ...
          */
        virtual unsigned int getNumRestarts() const
        {
            TA_Base_Core::ThreadGuard guard(m_lock);
        ...
        /**
          ...
          */
        virtual TA_Base_Core::EManagedProcessTerminateCode getTerminateStatus() const
        {
            TA_Base_Core::ThreadGuard guard(m_lock);
    ...
    protected:
        ...
        /**
          ...
          */
        virtual TA_Base_Core::DateTime_ul getTimeStarted() const
        {
            TA_Base_Core::ThreadGuard guard(m_lock);
