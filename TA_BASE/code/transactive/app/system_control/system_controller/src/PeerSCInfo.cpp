/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_controller/src/PeerSCInfo.cpp $
...
namespace TA_Base_App
{
    ...
    void PeerSCInfo::resolvePeer()
    {
        ...
        // "corbaloc::1.2@hostname:port/SystemControllerMonitor"
        std::ostringstream systemControllerMonitorString;
        systemControllerMonitorString << "corbaloc::1.2@" << m_peerHostname << ":"
