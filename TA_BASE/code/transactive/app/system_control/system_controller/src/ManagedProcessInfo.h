/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_controller/src/ManagedProcessInfo.h $
...
namespace TA_Base_App
{
    ...
    public:
        ...
        /**
          ...
          *
          */
        virtual bool isAPeer(const std::string& hostname) const;
        ...
        /**
          ...
          */
        virtual std::vector<std::string> getPeerHosts() const
        {
        ...
        /**
          ...
          */
        virtual std::string getDebugLevel() const
        {
            TA_Base_Core::ThreadGuard guard(m_lock);
...
//         std::string m_failoverAlarmId;
        ...
        static TA_Base_Core::NonReEntrantThreadLockable m_changeStateLock;
