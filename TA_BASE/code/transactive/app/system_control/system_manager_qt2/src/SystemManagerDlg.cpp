...
namespace TA_Base_App
{
    SystemManagerDlg::SystemManagerDlg( TA_Base_Bus::ITransActiveWinApp * app )
        : TA_Base_Bus::AbstractTransActiveDialog( app ),
          m_realPModel(NULL)
    {
        m_ui.setupUi( this );
    ...
    void SystemManagerDlg::onNewProcessData(WPARAM wparam, LPARAM lparam)
    {
    ...
    void SystemManagerDlg::onShutdownSystemController(WPARAM wparam, LPARAM lparam)
    {
        //try
        //{
