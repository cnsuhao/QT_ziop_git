/**
  ...
  * 
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_status_agent/src/taComponentsDriver/SystemControllerPoint.cpp $
	...
	*/
    bool SystemControllerPoint::resolve()
    {
	    ...
	    try
	    {
			...
			connectionStringStrm << "corbaloc::1.2@" << m_hostName << ":" << m_portNumber << "/SystemControllerAdmin";	    
