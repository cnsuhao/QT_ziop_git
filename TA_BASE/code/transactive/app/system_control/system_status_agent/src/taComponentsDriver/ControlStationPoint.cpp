/**
  ...
  * 
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_status_agent/src/taComponentsDriver/ControlStationPoint.cpp $
	...
	*/
	...
	bool ControlStationPoint::resolve()
    {
	    ...
	    try
	    {
			...
			connectionStringStrm << "corbaloc::1.2@" << m_hostName << ":" << m_portNumber << "/ControlStation";	    
