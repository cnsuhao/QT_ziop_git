/**
  ...
  * 
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_status_agent/src/pingDriver/ConsecutiveNetworkFailureAlarmPolicy.cpp $
  * @author:   Teik Oh
  * @version:  $Revision: #1 $
  *
