/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/system_manager_prev/dummy_agent/src/TestAgent.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
TestAgent::TestAgent()
{
    ...
    // "corbaloc::1.2@localhost:port/ProcessManager"
    std::ostringstream systemControllerString;
    systemControllerString << "corbaloc::1.2@localhost:"
                           << port
                           << "/ProcessManager";
