...
namespace TA_Base_App
{
    ...
    class ProcessParamsDlg : public TA_Base_Bus::AbstractDialog
    {
    ...
    public:
        ...
        /**
          ...
          */
        ProcessParamsDlg(TA_Base_Bus::ITransActiveWinApp * app, const std::vector<std::string> processes, CWnd* pParent = NULL);
    ...
    private:
        ...
        ProcessParamsDlgModel * m_realPModel;
