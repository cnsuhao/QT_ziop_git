...
BEGIN_MESSAGE_MAP(SystemManager, TransActiveWinApp)
	...
	TA_Base_Bus::IGUIApplicationController * SystemManager::createApplicationController()
	{
		TA_Base_Bus::IGUIApplicationController * pController = new TA_Base_App::SystemManagerAppController(this, "System Manager");
		return pController;
	}
