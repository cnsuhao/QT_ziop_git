/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/RunningApplication.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
public:
    ...
    /**
      ...
      *
      */
    void serverStateChanged(bool isServerUp);
    ...
    void terminating(unsigned long p_code) {} //test
...
typedef boost::shared_ptr<RunningApplication> RunningApplicationPtr;
