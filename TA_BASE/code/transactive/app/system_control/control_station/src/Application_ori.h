/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/Application.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
public:
    ...
    */
    ...
    unsigned int getResourceKey() { return m_resourceKey; }
