/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/QuickFindTreeObject.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
bool QuickFindTreeObject::createChildItemsOfRegion()
{
    ...
    m_hasChildren = !subsystems.empty();
