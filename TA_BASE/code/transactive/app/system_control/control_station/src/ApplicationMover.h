/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/ApplicationMover.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
public:
    ...
    /**
      ...
      */
    void setProcessDetails(unsigned long processId,
    ...
    /**
      ...
      */
    WindowMoveInformation& getProcessDetails()
    {
