/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/ControlStationConstants.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
#define RPARAM_INITIALIZE_COMPLETE              "RunParamsInitializeComplete"
