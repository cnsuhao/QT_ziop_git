/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/EditShortcutDialog.cpp $
  * @author:  San Teo
  * @version: $Revision: #1 $
  *
...
BOOL EditShortcutDialog::initDialog()
{
    FUNCTION_ENTRY("initDialog");
    CDialog::initDialog();
