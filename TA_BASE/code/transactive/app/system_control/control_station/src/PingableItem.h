/**
  ...
  *
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/PingableItem.h $
  * @author:   Anita Lee
  * @version:  $Revision: #1 $
  *
...
public:
    ...
    /**
      ...
      */
    PingableItem(const std::string ipAddress, FailurePolicyEnum policyType = CONSECUTIVE);
