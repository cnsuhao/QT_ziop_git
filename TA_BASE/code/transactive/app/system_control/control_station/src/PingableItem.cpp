/**
  ...
  *
  * Source:    $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/PingableItem.cpp $
  * @author:   Anita Lee
  * @version:  $Revision: #1 $
  *
...
PingableItem::PingableItem(const std::string ipAddress, FailurePolicyEnum policyType /*= CONSECUTIVE*/)
...
bool PingableItem::hasBeenProcessed() const
{
...
void PingableItem::setMaxConsecutiveFails(unsigned int consecutiveFails)
{
    ...
    ConsecutiveNetworkFailureAlarmPolicy* pConPolicy = dynamic_cast<ConsecutiveNetworkFailureAlarmPolicy*>(m_alarmPolicy);
