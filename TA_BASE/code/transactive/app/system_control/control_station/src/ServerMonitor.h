/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/ServerMonitor.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
class ServerMonitor : public TA_Base_Core::Thread, public Singleton<ServerMonitor>
{
public:
