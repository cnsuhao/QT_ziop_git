/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/SchematicDisplay.h $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
#pragma once
#include <atlcom.h>
#include "app/system_control/control_station/src/resource.h" // mainsymbols
