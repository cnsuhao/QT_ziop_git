/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/ScreenPositioning.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
class ScreenPositioning : public Singleton<ScreenPositioning>
{
public:
...
protected:
    ...
    ScreenPositioning();
    virtual void ScreenPositioning::asyncInitialize() override;

    void loadSystemScreenInfo();
    ...
    /**
      ...
      *                          to retrieve the layout options from the Control Station entity's configuration.
      */
    void loadLaunchBarScreenLayout(const TA_Base_Core::ControlStation& controlStationDatabaseEntry);
    ...
    static unsigned long LAUNCH_BAR_WIDTH;    // This is the width of the launch bar

    std::vector<bool> m_isBannerVisible;

    friend class ACE_Singleton<ScreenPositioning, ACE_Null_Mutex>;
};
