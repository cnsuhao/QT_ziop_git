/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/ControlStation2.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
private:
    ...
    /**
      ...
      *
      */
    std::string getAppName(const std::string& ex_str);
};
