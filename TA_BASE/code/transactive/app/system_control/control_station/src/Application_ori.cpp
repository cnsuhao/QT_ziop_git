/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/system_control/control_station/src/Application.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
  * Last modification: $DateTime: 2015/10/09 15:42:35 $  * Last modified by:  $Author: CM $
  *
...
using TA_Base_Core::IEntityDataPtr;
using TA_Base_Core::EntityAccessFactory;
using TA_Base_Core::IResourcePtr;
      ...
      m_transActiveApplication(true)  // always start with transactive apps
{
    ...
    if (ScreenPositioning::getInstance().isLaunchBarDisplayed())
    {
...
{
    FUNCTION_ENTRY("getIconFromFile");
...
{
    FUNCTION_ENTRY("getIconDirFromFile");
...
{
    FUNCTION_ENTRY("initialiseResourceKey");
    ...
    try
    {
        ...
        IEntityDataPtr entity(EntityAccessFactory::getInstance().getEntity(executable.c_str()));
