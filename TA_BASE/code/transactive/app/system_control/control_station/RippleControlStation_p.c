...
const CInterfaceProxyVtbl * const _RippleControlStation_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISchematicDisplayProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _RippleControlStation_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISchematicDisplayStubVtbl,
    0
};
...
const IID *  const _RippleControlStation_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
