/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanAgentUser.cpp $
                ...
                case TA_Base_Core::PASUT_ACTIVE_STEP_COMPLETION_STATUS_UPDATE:
                    {
                        ...
                        ActivePlanBulletinBoard::instance()->updateStepCompletionStatusMap(ascss);
                    }
                    break;
