/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePlanExecutingState.cpp $
...
namespace TA_Base_App
{
	...
	void ActivePlanExecutingStateImpl::complete( ActivePlan& activePlan ) const
	{
		...
		ActivePlanBulletinBoard::instance()->update( activePlan.getPlan(), TA_Base_Core::STOPPED_ACTIVE_PLAN_STATE, RemarkPlanCompletedSuccess );		
	}
...
//														 TA_Base_Core::PAUSED_ACTIVE_PLAN_STATE , remark);
	...
	void ActivePlanExecutingStateImpl::pauseForOperator( ActivePlan& activePlan ) const
	{
        ...
        ActivePlanBulletinBoard::instance()->update( activePlan.getPlan(), TA_Base_Core::OPERATOR_PAUSED_ACTIVE_PLAN_STATE, RemarkWaitingForOperatorResponse );
