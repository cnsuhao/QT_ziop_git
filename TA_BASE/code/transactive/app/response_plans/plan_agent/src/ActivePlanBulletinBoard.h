...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePlanBulletinBoard.h $
...
namespace TA_Base_App
{
	...
	public:
		...
		void update( const TA_Base_Core::ActivePlanId& plan, const unsigned long step, const std::string& stepName, const std::string& remark );
		void update( const TA_Base_Core::ActivePlanId& plan,const int state, const std::string& remark );
		void update( const TA_Base_Core::ActivePlanId& plan, const std::string& session, const std::string& pmId );
		void update( const TA_Base_Core::ActivePlanId& plan, const unsigned long step, const int state, const std::string& remark );
        ...
        void cullAllPlans();
        void pauseExpiredInteractivePlans ();
        ...
        void updateStepCompletionStatusMap(const TA_Base_Core::ActiveStepCompletionStatusSeq& statusSeq);
    ...
    private:
		...
		ACE_Time_Value getStepTimeout (const TA_Base_Core::ActivePlanId& plan, const unsigned long step);
        ...
        typedef std::map<TA_Base_Bus::SortableActiveStepId, int> StepCompletionStatusCacheMap;
        typedef StepCompletionStatusCacheMap::iterator StepCompletionStatusCacheMapIt;
        StepCompletionStatusCacheMap m_stepCompletionStatusCacheMap;
        mutable ACE_RW_Mutex m_stepCompletionStatusCacheMapLock;
