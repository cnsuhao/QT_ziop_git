...
*  in any form.
*
*  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/PlanAgentCorbaDefImpl.cpp $
...
namespace TA_Base_App
{
	...
	void PlanAgentCorbaDefImpl::resumePlanAtStep(const char* session, const TA_Base_Core::ActivePlanId& plan, TA_Base_Core::StepNumber step)
	{
		...
		{
			for (unsigned long i = 0u; i < executionHistory->details.length(); i++)
			{
