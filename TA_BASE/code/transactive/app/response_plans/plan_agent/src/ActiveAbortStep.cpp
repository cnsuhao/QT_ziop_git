...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveAbortStep.cpp $
...
namespace TA_Base_App
{
	...
	TA_Base_Core::EActiveStepState ActiveAbortStep::executeImpl( void )
	{
		...
		ActivePlanBulletinBoard::instance()->update( m_flowControl.getPlan(), TA_Base_Core::ABORTED_ACTIVE_PLAN_STATE , m_remark);
