...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePlanLaunchSchematicStepMessage.cpp $
  *  @author:  Bart Golab
  *  @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    void ActivePlanLaunchSchematicStepMessage::execute( ActivePlan& activePlan ) const
    {
		...
		ActivePlanBulletinBoard::instance()->update( activePlan.getPlan(), activeStep->getStepNumber(),
