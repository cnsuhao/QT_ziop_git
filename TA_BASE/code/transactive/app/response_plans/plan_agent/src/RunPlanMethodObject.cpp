/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/RunPlanMethodObject.cpp $
    ...
    int RunPlanMethodObject::call( void )
    {
        if ( NULL == m_activePlan.get() )
        {
            ...
            try
            {
                ...
                std::auto_ptr<ActivePlan> tmpPlan( new ActivePlan( stActivePlan, m_eInitialState, !m_bStartFromMonitorMode ));
