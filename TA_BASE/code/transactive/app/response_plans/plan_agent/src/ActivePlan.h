...
/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePlan.h $
...
namespace TA_Base_App
{
	...
	public:
		...
		virtual void setNextStep( const unsigned long step );                    
