/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActivePromptStep.cpp $
...
namespace TA_Base_App
{
	...
	ActivePromptStep::ActivePromptStep( const TA_Base_Core::StepDetail& stepDetail, 
        const TA_Base_Core::PromptParameters& params, IActivePlanFlow& flowControl ) : ActiveStep(stepDetail, flowControl),
    m_params(params)
	{
	}
