/**
  ...
  *  in any form.
  *
  *  Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_agent/src/ActiveLaunchSchematicStep.cpp $
  *  @author:  Bart Golab
  *  @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
	...
	ActiveLaunchSchematicStep::ActiveLaunchSchematicStep( const TA_Base_Core::StepDetail& stepDetail, 
        const TA_Base_Core::LaunchSchematicParameters& params, IActivePlanFlow& flowControl ) : ActiveStep(stepDetail, flowControl),
    m_params(params)
	{
	}
