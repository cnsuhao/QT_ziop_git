...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/common/src/StringConstants.h $
...
const char* const RemarkPlanTimeout = "Plan paused as it timed out";
...
const char* const RemarkInvalidDatapointValue = "Bad data point value";
