...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStep.h $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
namespace TA_Base_App
{
    ...
    public:
		...
		const TA_Base_Core::StepDetail& getStepDetails()
		{
			return m_stepDetail;
		}
        ...
        //virtual void updateCmdUI(CCmdUI &cmdUI); //TODO:move to view layer
