...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/SinglePlanInstanceListCtrl.cpp $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
void CSinglePlanInstanceListCtrl::PopulateInstance(const TA_Base_Core::ActivePlanDetail &activePlanDetail)
{
    ...
    SetItemText(0, ACTIVATION_COLUMN_INDEX, _T(activePlanDetail.timeOfInstantiation.in()));
