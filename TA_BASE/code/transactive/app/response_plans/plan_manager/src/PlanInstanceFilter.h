...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanInstanceFilter.h $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
namespace TA_Base_App
{
    ...
    public:
        ...
        bool isRelevant(const PlanInstance& planInstance);
