/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanNode.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    public:
        ...
        //void executeInteractiveStep(InteractiveStep& interactiveStep); //TODO
        ...
        PlanInstance *getPlanInstance(const PlanInstanceId &planInstanceId);

        // Return runtime class of the view used to display plan node details
        //virtual CRuntimeClass *getNodeViewClass();//TODO: 
        ...
        //TODO: carry out by means of calling notifyview
