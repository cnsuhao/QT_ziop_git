...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanBrowserDoc.h $
// @author:  Bart Golab
// @version: $Revision: #2 $
//
...
namespace TA_Base_App
{
    ...
    class CPlanBrowserDoc : public TA_Base_Bus::AbstractPModel,
                            public TA_Base_Core::QueueProcessor<std::string>,
    ...
    // Construction
    protected:
        CPlanBrowserDoc(TA_Base_Bus::IApplicationController* appController, const char * pmodelName);          // protected constructor used by dynamic creation
    ...
    public:
        ...
        void SetCurrentInstance(PlanInstance *instance);
        PlanInstance *GetCurrentInstance() const;
        ...
        virtual void processEvent( boost::shared_ptr<std::string> newEvent );
    ...
    private:
        ...
        PlanInstance *m_currentInstance;      // Active instance currently selected in this document's view.
        ...
        SynchronisedQueue<TA_Base_Core::ActivePlanDetail*> m_activePlanDetailUpdateQueue;
        SynchronisedQueue<TA_Base_Core::PlanConfigUpdateData*> m_planConfigDataUpdateQueue;
        SynchronisedQueue<TA_Base_Core::PlanCustomisationUpdate*> m_planCustomisationUpdateQueue;
    ...
    protected:
        ...
        void OnActivePlanDetailUpdate();
        void OnPlanConfigDataUpdate();
        void OnPlanCustomisationUpdate();
        void OnRparamExecPlanIdUpdate();
        void OnRparamViewPlanIdUpdate();
        void OnRparamAssocAlarmIdUpdate();
        void OnRparamLockCategoryUpdate();
        void OnRparamSessionIdUpdate();
        // }}AFX_MSG
        /*DECLARE_MESSAGE_MAP()*/
    };
