/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanEditorDoc.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
void CPlanEditorDoc::OnStepPaste()
{
    ...
    TA_ASSERT(m_copyStepList.size() > 0, "No plan has been copied or cut - cannot paste");
    TA_ASSERT(m_copyStepAction == SCA_CUT_STEP || m_copyStepAction == SCA_COPY_STEP, "Invalid paste action");
