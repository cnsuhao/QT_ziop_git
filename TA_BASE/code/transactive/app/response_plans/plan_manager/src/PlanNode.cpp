/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanNode.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
//#include "bus/generic_gui_view/src/applauncher.h"
...
const std::string &PlanNode::getNodeType()
{
    ...
    //static const std::string PLAN_NODE_TYPE = (LPCTSTR) LabelMaker::getPlanNodeTypeLabel(); TODO
    static const std::string PLAN_NODE_TYPE;
...
PlanInstance *PlanNode::getPlanInstance(const PlanInstanceId &instanceId)
{
    ...
    PlanInstance* instance = getPlanInstanceMap(instanceId.m_location).getPlanInstance(instanceId);
...
//        {
//            PlanInstance *planInstance = *iiter;
//
...
{
    //TODO: use view notify to update view
...
void PlanNode::controlPlan(bool ignoreActivePlanControllerLimit)
{
    ...
    {
        //TODO: Notify view to create thread
...
void PlanNode::editPlan()
{
    ...
    if (OperatorRights::getInstance().canEditPlans())
    {
        ...
        // FloatingWindowThreadRegister::getInstance().createPlanEditorThread(getNodeId()); TODO
    }
    else
    {
        //TODO: notify view to do so
