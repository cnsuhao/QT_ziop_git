...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanInstance.h $
// @author:  Bart Golab
// @version: $Revision: #1 $
//
...
#include "PlanManagerPModelConsts.h"
...
namespace TA_Base_App
{
    ...
    public:
        ...
        // lizettejl++ (DP-changes: added the position of the step currently selected )

        //TODO:move to view
        // virtual void updateCmdUI(CCmdUI &cmdUI, PlanNode &planNode, PlanStepNumber stepPosition = 0);
        // resumes plan instance at specific step position
        // virtual void resumAtStep(PlanStepNumber stepPosition);
        // ++lizettejl
    ...
    protected:
        ...
        TA_Base_Core::ActivePlanDetail& getActivePlanDetail();
    private:
