...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanManagerCorbaDefImpl.cpp $
// @author:  Bart Golab
// @version: $Revision: #2 $
//
...
int PlanManagerCorbaDefImpl::toActivate()
{
    ...
    {
		//TA_Base_Bus::UINotificationDataContextPtr dataContextPtr(new TA_Base_Bus::UINotificationDataContext(IDS_UE_210072));
		//TA_Base_Bus::UIReplyEventArgsPtr eventArgs(new TA_Base_Bus::UIReplyEventArgs(dataContextPtr, APP_NOTIFY_ERROR_PLANAGENT_LOCATIONS));
...
//    {
//		//TA_Base_Bus::UINotificationDataContextPtr dataContextPtr(new TA_Base_Bus::UINotificationDataContext(IDS_UE_210072));
//		//TA_Base_Bus::UIReplyEventArgsPtr eventArgs(new TA_Base_Bus::UIReplyEventArgs(dataContextPtr, APP_NOTIFY_ERROR_REGISTER_PLANMANAGER));
//		//m_appController->getWinApp()->requestUserReply(eventArgs);
//    }
//
//    FUNCTION_EXIT;
