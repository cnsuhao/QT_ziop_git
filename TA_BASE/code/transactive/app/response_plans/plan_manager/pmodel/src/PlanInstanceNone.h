...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanInstanceNone.h $
// @author:  Bart Golab
// @version: $Revision: #3 $
//
...
namespace TA_Base_App
{
    ...
    public:
        ...
        virtual void addToPlanInstanceList(PlanInstanceListCtrl &listCtrl);
