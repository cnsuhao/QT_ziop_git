...
const std::string &CategoryNode::getNodeType()
{
	...
	static const std::string CATEGORY_NODE_TYPE = LabelMaker::getCategoryNodeTypeLabel();
...
const std::string &CategoryNode::getNodeStatus()
{
	...
	static const std::string EMPTY_CATEGORY_STATUS = LabelMaker::getEmptyCategoryLabel();
	static const std::string NONEMPTY_CATEGORY_STATUS = LabelMaker::getNonEmptyCategoryLabel();
...
const std::string CategoryNode::getNodeImageType(bool isExpanded)
{
	FUNCTION_ENTRY("getNodeImageType");
	FUNCTION_EXIT;
	return (isExpanded ? ICON_OPEN_FOLDER : ICON_CLOSED_FOLDER);
}
