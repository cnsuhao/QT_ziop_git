...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/RootNode.cpp $
// @author:  Bart Golab
// @version: $Revision: #3 $
//
...
const std::string &RootNode::getNodeType()
{
    ...
    static const std::string ROOT_NODE_TYPE = LabelMaker::getRootNodeTypeLabel();
...
const std::string RootNode::getNodeImageType(bool isExpanded)
{
