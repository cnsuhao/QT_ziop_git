/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanAgentAccess.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #2 $
  *
...
TA_Base_Core::ActivePlanDetails *PlanAgentAccess::getActivePlanDetailsAtLocation(TA_Base_Core::NodeId planNodeId, unsigned long location)
{
    ...
    PAA_BEGIN_TRY
    {
        ...
        {   //as per TD 13167
			std::stringstream ssLocationId;
			ssLocationId << location;
			TA_THROW(PlanAgentAccessException(ex.what(), ssLocationId.str()));
        }
...
//		TA_Base_Bus::TA_Rect newRect = TA_Base_Bus::AppLauncher::getInstance().getRect(TA_Base_Bus::TA_GenericGui::SCREEN_CURRENT,
