...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanInstance.h $
// @author:  Bart Golab
// @version: $Revision: #3 $
//
...
namespace TA_Base_App
{
    ...
    public:
        ...
        //virtual void updateCmdUI(CCmdUI &cmdUI, PlanNode &planNode, PlanStepNumber stepPosition = 0); //QTTODO
