...
// in any form.
//
// Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStepParameterPlanPathEditDlg.cpp $
// @author:  Andy Parker
// @version: $Revision: #1 $
//
...
void CPlanStepParameterPlanPathEditDlg::OnPlanTreeItemSelected(NMHDR* pNMHDR, LRESULT* pResult)
{
    ...
    m_planPath = (planItem != NULL ? SCOPEDMTOW(planItem->getPlanPath().c_str()) : _T(""));
    UpdateData(FALSE);
