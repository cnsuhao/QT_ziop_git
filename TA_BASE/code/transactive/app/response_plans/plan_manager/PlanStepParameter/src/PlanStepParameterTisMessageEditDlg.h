/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStepParameterTisMessageEditDlg.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class CPlanStepParameterTisMessageEditDlg : public CPlanStepParameterEditDlg
    {
        ...
        public:
            ...
            // Operations
        public:
            TisConfigAccess::PredefinedTisMessage GetSelectedMessage() const
            {
