/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PlanStepParameterTisPidListEditDlg.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class CPlanStepParameterTisPidListEditDlg : public CPlanStepParameterEditDlg
    {
        ...
        public:
            std::vector<std::string> GetSelectedPids() const
            {
