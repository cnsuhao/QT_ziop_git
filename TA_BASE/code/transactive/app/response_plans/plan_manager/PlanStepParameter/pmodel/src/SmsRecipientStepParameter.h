/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/SmsRecipientStepParameter.h $
    ...
    class SmsRecipientStepParameter : public PlanStepParameter
    {
        public:
            ...
            /**
              ...
              */
            std::string getRecipientIdentifier() const
            {
