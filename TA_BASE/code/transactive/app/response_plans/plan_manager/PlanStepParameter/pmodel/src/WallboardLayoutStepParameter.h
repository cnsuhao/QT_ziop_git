/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/WallboardLayoutStepParameter.h $
...
namespace TA_Base_App
{
    ...
    class WallboardLayoutStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            unsigned long getLayoutKey() const
            {
                return m_layoutKey;
            }
