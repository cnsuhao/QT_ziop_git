/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/SmsRecipientStepParameter.cpp $
...
void SmsRecipientStepParameter::addToParameterList(CPlanStepParameterListCtrlModel& listCtrl)
{
    ...
    unsigned int index = m_recipientIdentifier.find(":", 0);
