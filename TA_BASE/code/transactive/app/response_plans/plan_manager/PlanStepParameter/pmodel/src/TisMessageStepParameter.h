/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/TisMessageStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class TisMessageStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::TISMessage getMessage() const
            {
                return m_message;
            }
