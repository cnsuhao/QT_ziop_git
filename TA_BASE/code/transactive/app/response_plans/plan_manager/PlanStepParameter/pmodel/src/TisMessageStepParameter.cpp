/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/TisMessageStepParameter.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
void TisMessageStepParameter::addToParameterList(CPlanStepParameterListCtrlModel &listCtrl)
{
