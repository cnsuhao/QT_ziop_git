/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/StationStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class StationStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::StationDestination getDestination() const
            {
