/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/MonitorStepParameter.cpp $
...
void MonitorStepParameter::addToParameterList(CPlanStepParameterListCtrlModel &listCtrl)
{
