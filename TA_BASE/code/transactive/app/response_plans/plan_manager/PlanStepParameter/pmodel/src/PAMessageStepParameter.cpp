/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PAMessageStepParameter.cpp $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
void PaMessageStepParameter::addToParameterList(CPlanStepParameterListCtrlModel &listCtrl)
{
    ...
    listCtrl.addParameter(getName().c_str(), messageLabel, this);
