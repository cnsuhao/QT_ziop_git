/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/TisPriorityStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class TisPriorityStepParameter : public NumericStepParameter
    {
        ...
        public:
            ...
            {
                return static_cast<unsigned short>(getNumericValue());
            }
