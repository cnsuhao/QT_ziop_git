/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PAMessageStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class PaMessageStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::PAMessage getPAMessage() const
            {
                return m_paMessage;
            }
            ...
            unsigned long  getPAMessageId()
            {
                return m_paMessage.messageId;
            }
            unsigned short getPAMessageLibVersion()
            {
                return m_paMessage.libVersion;
            }
            unsigned short getPAMessageLibSection()
            {
                return m_paMessage.libSection;
            }
