/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/WallboardStepParameter.h $
...
namespace TA_Base_App
{
    ...
    class WallboardStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            unsigned long getWallboardKey() const
            {
                return m_wallboardKey;
            }
            std::string getWallboardName() const
            {
                return m_wallboardName;
            }
