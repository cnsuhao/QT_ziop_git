/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/DataPointValueStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class DataPointValueStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::DataPointValue getDataPointValue() const
            {
                return m_value;
            }
