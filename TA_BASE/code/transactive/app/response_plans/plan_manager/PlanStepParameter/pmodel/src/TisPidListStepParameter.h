/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/TisPidListStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class TisPidListStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::TISPidList getPids() const
            {
                return m_pids;
            }
