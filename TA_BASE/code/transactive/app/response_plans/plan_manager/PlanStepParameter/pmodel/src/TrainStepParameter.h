/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/TrainStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class TrainStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::TrainDestination getDestination() const
            {
