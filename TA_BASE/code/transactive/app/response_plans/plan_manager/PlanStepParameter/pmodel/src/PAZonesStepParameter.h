/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI/TA_BASE/transactive/app/response_plans/plan_manager/src/PAZonesStepParameter.h $
  * @author:  Bart Golab
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_App
{
    ...
    class PaZonesStepParameter : public PlanStepParameter
    {
        ...
        public:
            ...
            TA_Base_Core::StationZones getPAZones() const
            {
                return m_paZones;
            }
