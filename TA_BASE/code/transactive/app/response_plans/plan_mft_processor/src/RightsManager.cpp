/**
  ...
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/app/response_plans/plan_mft_processor/src/RightsManager.cpp $
  * @author:  Huang Qi
  * @version: $Revision: #1 $
  *
...
bool RightsManager::isActionPermittedOnResource( const unsigned long ulEntityKey, const unsigned long ulActionId )
{
