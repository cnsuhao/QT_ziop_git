/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/exceptions/src/GraphWorxException.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        /**
          ...
          *
          */
        GraphWorxException(const char* msg, const EFail type) throw();
        GraphWorxException(const std::string& msg, const EFail type) throw();
