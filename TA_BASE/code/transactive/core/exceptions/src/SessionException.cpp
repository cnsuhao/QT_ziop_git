/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/exceptions/src/SessionException.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
{
    SessionException::SessionException(const char* msg)
        : m_failType(GENERAL_ERROR),
          TransactiveException(msg)
    {
    }

    SessionException::SessionException(const EFailType failType, const char* msg)
        : m_failType(failType),
          TransactiveException(msg)
    {
