/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/exceptions/src/SessionException.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        /**
          ...
          */
        SessionException() {}
        SessionException(const char* msg);
        ...
        /**
          ...
          *
          */
        SessionException(const EFailType failType, const char* msg);
