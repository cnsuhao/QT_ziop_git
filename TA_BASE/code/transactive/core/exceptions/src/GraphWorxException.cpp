/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/exceptions/src/GraphWorxException.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    GraphWorxException::GraphWorxException(const char* msg, const EFail type) throw()
    ...
    GraphWorxException::GraphWorxException(const std::string& msg, const EFail type) throw()
        : TransactiveException(msg),
          m_type(type)
