/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/message/src/ConnectionChecker.cpp $
...
namespace TA_Base_Core
{
    ...
    void gAddNotifyHostConnections(ChannelLocatorConnectionMgr* mgr)
    {
        ...
        std::string notifyHosts = TA_Base_Core::RunParams::getInstance().promiseGet(RPARAM_NOTIFYHOSTS, 10000);
