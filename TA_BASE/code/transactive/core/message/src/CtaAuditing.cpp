/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/message/src/CtaAuditing.cpp $
  * @author:  K. Graham
  * @version: $Revision: #1 $
  *
...
#include "core/message/types/Audit_MessageTypes.h"
...
namespace TA_Base_Core
{
	...
	CtaAuditing::CtaAuditing(unsigned long entityKey)
		: m_appEntityKey(entityKey)
	{
		m_messageSender.reset( MessagePublicationManager::getInstance().getAuditMessageSender(Audit::Context) );
		TA_ASSERT(m_messageSender.get() != NULL, "The message sender could not be created");
	}
