...
* in any form.
*
* Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/message/src/TA_CosUtility.cpp $
...
namespace TA_Base_Core
{
    ...
    unsigned long gGetLocalLocationKey()
    {
        ...
        if (s_localLocationKey == LONG_MAX)
        {
            ...
            TA_ASSERT(RunParams::getInstance().promiseIsSet(RPARAM_LOCATIONKEY, 10000), "LocationKey is not set");
