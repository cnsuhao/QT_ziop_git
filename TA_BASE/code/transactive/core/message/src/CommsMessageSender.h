...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/message/src/CommsMessageSender.h $
  * @author:  Jade Welton
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    typedef boost::shared_ptr<CommsMessageSender> CommsMessageSenderPtr;
}; // TA_Base_Core
