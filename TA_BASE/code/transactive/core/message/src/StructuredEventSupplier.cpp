/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/message/src/StructuredEventSupplier.cpp $
  * @author:  Jade Welton
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    bool RedundantEventSupplier::publishEvents(const std::vector<TA_Base_Core::TimetagedStructuredEvent*>& batch)
    {
        ...
        if (m_connections.size() == 0)
        {
            ...
            */
            if (m_lastConnectionSize != m_connections.size())
            {
                ...
                m_lastConnectionSize = m_connections.size();
                return false;
            }
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    StructuredEventSupplier::StructuredEventSupplier(/*takes*/ IQueueHandler<TA_Base_Core::TimetagedStructuredEvent>* handler)
        : m_handler(handler)
    {
        TA_ASSERT(RunParams::getInstance().promiseIsSet(RPARAM_NOTIFYHOSTS, 10000), "No Notification Service hosts specified");
