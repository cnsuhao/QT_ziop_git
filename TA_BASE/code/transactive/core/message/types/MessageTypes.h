...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/message/types/MessageTypes.h $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        MessageContext(const char* channel, const char* context, EMessageCategory notUsed)
    ...
    public:
        ...
        bool operator == (const MessageContext& rhs) const
        {
            return m_channelName == rhs.getChannelName() && m_contextName == rhs.getContextName();
        }
    ...
    public:
        ...
        MessageType(MessageContext& context, const char* typeKey)
    ...
    public:
        ...
        {
            return m_context == rhs.getContextObj() && m_typeKey == rhs.getTypeKey();
        }
