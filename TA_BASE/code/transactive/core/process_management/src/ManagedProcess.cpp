/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/process_management/src/ManagedProcess.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
          ...
          m_pollListener(pollListener)
    {
        ...
        try
        {
            ...
            if (RunParams::getInstance().isSet("LocalTest"))
            {
                hasRegistered = true;
            }
            else
    ...
    void ManagedProcess::locateProcessManager()
    {
        try
        {
            ...
            ior << "corbaloc::1.2@localhost:" << port << "/ProcessManager";
