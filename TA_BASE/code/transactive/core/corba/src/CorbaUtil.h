...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/corba/src/CorbaUtil.h $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        std::pair<boost::promise<void>, boost::shared_future<void> > m_activatedPromise;
    }; // CorbaUtil
}; // TA_Base_Core
