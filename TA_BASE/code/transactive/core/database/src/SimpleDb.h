...
* in any form.
*
* Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/database/src/SimpleDb.h $
* @author:  Ripple
* @version: $Revision: #1 $
*
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        static std::vector<std::string> ParseConnectStr(const std::string& str, char delimiter = ':');
        ...
        */
        ...
        static std::string getDbNameFromConnectStr(const std::string& str);
