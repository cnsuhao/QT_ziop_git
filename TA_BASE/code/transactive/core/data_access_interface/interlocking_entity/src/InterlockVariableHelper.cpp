/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking_entity/src/InterlockVariableHelper.cpp $
  * @author:  Robert Stagg
  * @version: $Revision: #1 $
  *
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_VARIABLE_TYPES_SELECT_32503, m_entityType);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_VARIABLE_TYPES_SELECT_32503, m_entityType);
