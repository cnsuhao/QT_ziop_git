/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking_entity/src/InterlockEntityHelper.cpp $
  * @author:  Robert Stagg
  * @version: $Revision: #1 $
  *
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_ENTITY_TYPES_STD_SELECT_32002, 
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_ENTITY_TYPES_SELECT_32002, 
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_ENTITY_TYPES_SELECT_32002,
