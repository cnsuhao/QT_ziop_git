/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking_entity/src/InterlockEntityAccessFactory.h $
  * @author:  Robert Stagg
  * @version: $Revision: #1 $
  *
...
#ifndef INTERLOCK_ENTITY_ACCESS_FACTORY_H
#define INTERLOCK_ENTITY_ACCESS_FACTORY_H
...
namespace TA_Base_Core
{
    ...
    private:
        static InterlockEntityAccessFactory* s_instance;
