/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking/src/InterlockRuleAccessFactory.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
...
{
    InterlockRuleAccessFactory* InterlockRuleAccessFactory::s_instance = 0;
    TA_Base_Core::NonReEntrantThreadLockable InterlockRuleAccessFactory::s_singletonLock;
    ...
    InterlockRuleAccessFactory& InterlockRuleAccessFactory::getInstance()
    {
        ...
        if( s_instance == 0 )
        {
            s_instance = new InterlockRuleAccessFactory();
        }
        return *s_instance;
    }
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_STD_SELECT_31501, key);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_SELECT_31501, key);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_SELECT_31501, key);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_STD_SELECT_31502, entity);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_SELECT_31502, entity);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_SELECT_31502, entity);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_STD_SELECT_31503);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_SELECT_31503);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_SELECT_31503);
