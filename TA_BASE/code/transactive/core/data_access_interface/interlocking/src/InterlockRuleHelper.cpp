/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking/src/InterlockRuleHelper.cpp $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_Oracle_SELECT_31551, m_key);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_SELECT_31551, m_key);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_SELECT_31551, m_key);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_ALIAS_STD_SELECT_31002, m_key);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_ALIAS_SELECT_31002, m_key);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_ALIAS_SELECT_31002, m_key);
    ...
    {       
        ...
        {
            TA_THROW(TA_Base_Core::DataConfigurationException("Interlocking rule data not fully specified. Interlocking rule cannot be written to database", fieldNames));
        }
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_ALIAS_STD_DELETE_31401, m_key);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_ALIAS_DELETE_31401, m_key);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_ALIAS_DELETE_31401, m_key);
        databaseConnection->executeModification(strSql);

        /*sql.str("");
        sql << "delete from LK_INTERLOCKING_RULES where LKIRUL_ID = " << m_key;*/
//		strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_STD_DELETE_31901, m_key);
//		strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_DELETE_31901, m_key);

		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_DELETE_31901, m_key);
        databaseConnection->executeModification(strSql);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_Oracle_UPDATE_31701,databaseConnection->escapeInsertString(m_name),
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_UPDATE_31701,databaseConnection->escapeInsertString(m_name),
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_UPDATE_31701,databaseConnection->escapeInsertString(m_name),
			m_entityKey, m_entityType,databaseConnection->escapeInsertString(m_desiredState),getParametersAsString(*databaseConnection), 
			(m_preCondition ? STRING_TRUE : STRING_FALSE), databaseConnection->escapeInsertString(m_condition), databaseConnection->escapeInsertString(m_description),
			(m_enabled ? STRING_TRUE : STRING_FALSE), m_key);
        ...
        /*sql.str("");
        sql << "delete from LK_ALIAS where LKIRUL_ID = " << m_key;*/
//		strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_ALIAS_STD_DELETE_31401, m_key);
//		strSql  = databaseConnection->prepareSQLStatement(LK_ALIAS_DELETE_31401, m_key);
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_STD_SELECT_31504);
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_SELECT_31504);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_SELECT_31504);
...
//		strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_Oracle_SELECT_31552);
//		strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_SELECT_31552);

		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_SELECT_31552);
        ...
        sql << ")";*/
//		strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_INTERLOCKING_RULES_Oracle_INSERT_31851, m_key, m_name, m_entityKey, m_entityType,
//		strSql  = databaseConnection->prepareSQLStatement(LK_INTERLOCKING_RULES_INSERT_31851, m_key, m_name, m_entityKey, m_entityType,

		databaseConnection->prepareSQLStatement(strSql, LK_INTERLOCKING_RULES_INSERT_31851, m_key, m_name, m_entityKey, m_entityType,
			databaseConnection->escapeInsertString(m_desiredState), getParametersAsString(*databaseConnection), (m_preCondition ? STRING_TRUE : STRING_FALSE),
			databaseConnection->escapeInsertString(m_condition), databaseConnection->escapeInsertString(m_description), (m_enabled ? STRING_TRUE : STRING_FALSE) );
