/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking/src/InterlockRuleAccessFactory.h $
  * @author:  Ross Tucker
  * @version: $Revision: #1 $
  *
...
#ifndef INTERLOCK_RULE_ACCESS_FACTORY_H
#define INTERLOCK_RULE_ACCESS_FACTORY_H
...
namespace TA_Base_Core
{
    ...
    private:
        static InterlockRuleAccessFactory* s_instance;
