/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/entity_access/src/EntityHelper.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    public:
		...
		//xinsong add, just for test when filling data without db
		void setIsValidData()
		{
			m_isValidData = true;
		}//end xinsong add
