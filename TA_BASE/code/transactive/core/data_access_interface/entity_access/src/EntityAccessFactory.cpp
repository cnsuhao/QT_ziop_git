/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/entity_access/src/EntityAccessFactory.cpp $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    {
        static EntityAccessFactory* factory = new EntityAccessFactory;
        return *factory;
    }
