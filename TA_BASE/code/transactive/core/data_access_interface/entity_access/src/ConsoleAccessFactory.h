/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/entity_access/src/ConsoleAccessFactory.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        IConsole* getConsoleByName(const std::string& name) { return getConsole(name); }
