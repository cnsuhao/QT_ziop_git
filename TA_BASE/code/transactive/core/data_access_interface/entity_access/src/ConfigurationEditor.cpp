/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/entity_access/src/ConfigurationEditor.cpp $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    bool ConfigurationEditor::isConfigurationEditorAlreadyRunning(std::string& workstationName)
    {
        ...
        int beginOfSchema = dbConnectionString.find_first_of(':') + 1;
        int endOfSchema = dbConnectionString.find_first_of(':',beginOfSchema);
