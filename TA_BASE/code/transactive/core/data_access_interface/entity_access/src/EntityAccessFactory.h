/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/entity_access/src/EntityAccessFactory.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        IEntityData* getEntityByName(const std::string& name) { return getEntity(name); }
        //liqiang++
