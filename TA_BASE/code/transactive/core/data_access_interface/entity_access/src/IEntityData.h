/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/entity_access/src/IEntityData.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    typedef std::vector<IEntityDataPtr> SharedIEntityDataList;
    typedef SharedIEntityDataList IEntityDataPtrList;
    typedef std::map<unsigned long, IEntityDataPtr> SharedIEntityDataMap;
    typedef SharedIEntityDataMap IEntityDataPtrMap;
