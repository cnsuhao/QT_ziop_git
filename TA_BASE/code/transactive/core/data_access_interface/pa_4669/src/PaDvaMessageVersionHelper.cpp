/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaDvaMessageVersionHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(PA_DVA_MESSAGE_VERSION_DELETE_43401, m_key.getValue());
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, PA_DVA_MESSAGE_VERSION_DELETE_43401, m_key.getValue());
...
//		std::string strSql = databaseConnection->prepareSQLStatement(PA_DVA_MESSAGE_VERSION_UPDATE_43151,
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, PA_DVA_MESSAGE_VERSION_UPDATE_43151,
...
//             << (databaseConnection->escapeInsertString(m_strVersion)).c_str()
//             << "')";
//		std::string strSql = databaseConnection->prepareSQLStatement(PA_DVA_MESSAGE_VERSION_INSERT_43301,
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, PA_DVA_MESSAGE_VERSION_INSERT_43301,
