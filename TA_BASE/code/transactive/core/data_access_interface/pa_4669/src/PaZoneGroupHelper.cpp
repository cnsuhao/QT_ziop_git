/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/pa_4669/src/PaZoneGroupHelper.cpp $
  * @author:  Jade Lee
  * @version: $Revision: #1 $
  *
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(PA_ZONE_GROUP_DELETE_45901, m_key);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, PA_ZONE_GROUP_DELETE_45901, m_key);
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(PA_ZONE_GROUP_DELETE_45902, groupKey);
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, PA_ZONE_GROUP_DELETE_45902, groupKey);
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(PA_ZONE_GROUP_DELETE_45903, sql.str());
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, PA_ZONE_GROUP_DELETE_45903, groupKey, sql.str());
