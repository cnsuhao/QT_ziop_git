/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking_variable/src/InterlockVariableHelper.cpp $
  * @author:  Robert Stagg
  * @version: $Revision: #1 $
  *
...
//		std::string strSql = defPrepareSQLStatement(databaseConnection->GetDbServerType(), LK_VARIABLE_TYPES_STD_SELECT_32503, 
//		std::string strSql  = databaseConnection->prepareSQLStatement(LK_VARIABLE_TYPES_SELECT_32503, 
		SQLStatement strSql;
		databaseConnection->prepareSQLStatement(strSql, LK_VARIABLE_TYPES_SELECT_32503,
			databaseConnection->escapeQueryString(m_entityType));
