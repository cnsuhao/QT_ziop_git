/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/interlocking_variable/src/InterlockVariableAccessFactory.h $
  * @author:  Robert Stagg
  * @version: $Revision: #1 $
  *
...
#ifndef INTERLOCK_VARIABLE_ACCESS_FACTORY_H
#define INTERLOCK_VARIABLE_ACCESS_FACTORY_H
...
namespace TA_Base_Core
{
    ...
    private:
        static InterlockVariableAccessFactory* s_instance;
