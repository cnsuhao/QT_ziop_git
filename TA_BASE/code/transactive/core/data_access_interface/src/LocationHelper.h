/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/src/LocationHelper.h $
  * @author Karen Graham
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    public:
        ...
        LocationHelper( const unsigned long key, const std::string& name, const std::string& description, const unsigned long orderId,
                         const std::string displayname, const time_t dateCreated, const time_t dateModified, bool displayOnly = false);
