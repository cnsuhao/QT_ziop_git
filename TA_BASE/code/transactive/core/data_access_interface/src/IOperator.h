/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/src/IOperator.h $
  * @author Nick Jardine
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    typedef std::vector<IOperator*> IOperatorList;
    typedef std::vector<IOperatorPtr> IOperatorPtrList;
