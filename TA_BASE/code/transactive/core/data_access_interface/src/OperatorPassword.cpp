...
//					strSql  = databaseConnection->prepareSQLStatement(OPERATOR_PASSWORD_UPDATE_LOGTIM_74006,  m_operatorKey); 			
		...
		databaseConnection->prepareSQLStatement(strSql, OPERATOR_PASSWORD_UPDATE_LOGTIM_74006,  m_operatorKey);
					databaseConnection->executeModification(strSql);
				}
				else 
				{
...
//						strSql  = databaseConnection->prepareSQLStatement(OPERATOR_PASSWORD_UPDATE_LOCKTIM_74007, (++m_isPasswordLockout), m_operatorKey); 		
		...
		databaseConnection->prepareSQLStatement(strSql, OPERATOR_PASSWORD_UPDATE_LOCKTIM_74007, (++m_isPasswordLockout), m_operatorKey);
...
//						strSql  = databaseConnection->prepareSQLStatement(OPERATOR_PASSWORD_UPDATE_LOCKTIM_74008, (++m_isPasswordLockout), m_operatorKey); 		
		...
		databaseConnection->prepareSQLStatement(strSql, OPERATOR_PASSWORD_UPDATE_LOCKTIM_74008, (++m_isPasswordLockout), m_operatorKey);
					else
//						strSql  = databaseConnection->prepareSQLStatement(OPERATOR_PASSWORD_UPDATE_LOCKTIM_74009, (password_reuse_max) ,m_operatorKey); 		

		databaseConnection->prepareSQLStatement(strSql, OPERATOR_PASSWORD_UPDATE_LOCKTIM_74009, (password_reuse_max) ,m_operatorKey);
