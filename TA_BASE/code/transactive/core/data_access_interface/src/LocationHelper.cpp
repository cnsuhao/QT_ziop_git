/**
  ...
  * in any form.
  *
  * Source: $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/src/LocationHelper.cpp $
  * @author Karen Graham
  * @version $Revision: #1 $
...
namespace TA_Base_Core
{
    ...
    void LocationHelper::reload()
    {
        ...
        sql << "TO_CHAR(DATE_CREATED,'YYYYMMDDHH24MISS')),IS_DISPLAY_ONLY FROM LOCATION WHERE PKEY = " << m_key;*/
...
//		std::string strSql  = databaseConnection->prepareSQLStatement(LOCATION_SELECT_7002, 
        ...
        /*formatSQL.str("");
        formatSQL << "insert into LOCATION (PKEY,NAME,DESCRIPTION,ORDER_ID,IS_DISPLAY_ONLY) ";
...
//		strSql  = databaseConnection->prepareSQLStatement(LOCATION_INSERT_7351, databaseConnection->escapeInsertString(m_name),
		...
		databaseConnection->prepareSQLStatement(strSql, LOCATION_INSERT_7351, databaseConnection->escapeInsertString(m_name),
