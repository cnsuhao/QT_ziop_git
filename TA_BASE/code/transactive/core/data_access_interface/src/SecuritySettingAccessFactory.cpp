...
namespace TA_Base_Core
{
    ...
    void SecuritySettingAccessFactory::reload()
    {
        ...
        m_setting.reset(new SecuritySetting);

        m_setting->m_automatic_logout_time = m_AUTOMATIC_LOGOUT_TIME;
        m_setting->m_failed_login_attempts = m_FAILED_LOGIN_ATTEMPTS;
        m_setting->m_password_reuse_max = m_PASSWORD_REUSE_MAX;
        m_setting->m_password_warn_time = m_PASSWORD_WARN_TIME;
        m_setting->m_password_reuse_time = m_PASSWORD_REUSE_TIME;
        m_setting->m_password_life_time = m_PASSWORD_LIFE_TIME;
        m_setting->m_password_lock_time = m_PASSWORD_LOCK_TIME;
    ...
    SecuritySettingPtr SecuritySettingAccessFactory::getSetting()
    {
        if (!m_hasLoad)
        {
            reload();
