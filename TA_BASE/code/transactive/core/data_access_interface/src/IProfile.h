/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/src/IProfile.h $
  * @author:  Karen Graham
  * @version: $Revision: #1 $
  *
...
namespace TA_Base_Core
{
    ...
    typedef std::vector<IProfile*> IProfileList;
    typedef boost::shared_ptr<IProfile> IProfilePtr;
    typedef std::vector<IProfilePtr> IProfilePtrList;
