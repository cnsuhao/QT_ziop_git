/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/src/CombinedEventAccessFactory.h $
...
namespace TA_Base_Core
{
    ...
    private:
        ...
        CombinedEventAccessFactory() : m_stopLoad(false), m_pauseLoad(false), m_curMaxPkey(0),
              m_isLoadingAll(false),m_lastWhereClauseAlwaysFalse(false)
        {
        }
