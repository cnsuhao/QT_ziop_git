 ...
 * in any form.
 *
 * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/data_access_interface/src/MessageData.cpp $
 * @author:  Nick Jardine
 * @version: $Revision: #1 $
 *
...
//     void MessageData::createNewMessage()
    ...
    // CL-21508 end
    {
        ...
        char logTimeString[24]; // buffer [22] not long enough to contain "%02d/%02d/%04d %02d:%02d:%02d.%03d"
...
//      strSql  = databaseConnection->prepareSQLStatement(EVENT_INSERT_17353, getLocalDatabaseName(), 100, databaseConnection->escapeAQSQLString(logTimeString),m_locationKey,
        ...
        databaseConnection->prepareSQLStatement(strSql, EVENT_INSERT_17353, getLocalDatabaseName(), 100, databaseConnection->escapeAQSQLString(logTimeString), m_locationKey,
