/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/PRIV_GenericGUI_QT/TA_BASE/transactive/core/utilities/src/GenericLogType.cpp $
  * @author:  Ripple
  * @version: $Revision: #1 $
  *
...
{
    std::string GenericLogType::getCompleteLogMessage(const std::string& filename, int line, va_list& args)
    {
        // Check preconditions
        ...
        try
        {
            ...
            levelStr = DebugUtil::getStringDebugLevel((TA_Base_Core::DebugUtil::EDebugLevel) level);
        }
        catch (...)
        {
